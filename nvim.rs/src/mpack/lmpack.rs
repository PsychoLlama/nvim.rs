...
pub const UNPACKER_META_NAME: [::core::ffi::c_char; 15] = unsafe {
    ::core::mem::transmute::<[u8; 15], [::core::ffi::c_char; 15]>(*b"mpack.Unpacker\0")
};
pub const UNPACK_FN_NAME: [::core::ffi::c_char; 7] = unsafe {
    ::core::mem::transmute::<[u8; 7], [::core::ffi::c_char; 7]>(*b"decode\0")
};
pub const PACKER_META_NAME: [::core::ffi::c_char; 13] = unsafe {
    ::core::mem::transmute::<[u8; 13], [::core::ffi::c_char; 13]>(*b"mpack.Packer\0")
};
pub const PACK_FN_NAME: [::core::ffi::c_char; 7] = unsafe {
    ::core::mem::transmute::<[u8; 7], [::core::ffi::c_char; 7]>(*b"encode\0")
};
pub const SESSION_META_NAME: [::core::ffi::c_char; 14] = unsafe {
    ::core::mem::transmute::<[u8; 14], [::core::ffi::c_char; 14]>(*b"mpack.Session\0")
};
pub const NIL_NAME: [::core::ffi::c_char; 10] = unsafe {
    ::core::mem::transmute::<[u8; 10], [::core::ffi::c_char; 10]>(*b"mpack.NIL\0")
};
...
unsafe extern "C" fn lmpack_grow_parser(
    mut parser: *mut mpack_parser_t,
) -> *mut mpack_parser_t {
    let mut old: *mut mpack_parser_t = parser;
    let mut new_capacity: mpack_uint32_t = (*old)
        .capacity
        .wrapping_mul(2 as mpack_uint32_t);
    parser = malloc(
...
unsafe extern "C" fn lmpack_objlen(
    ...
    if -1 as ::core::ffi::c_int as size_t
        > -1 as ::core::ffi::c_int as mpack_uint32_t as size_t
        && len > -1 as ::core::ffi::c_int as mpack_uint32_t as size_t
    {
        len = -1 as ::core::ffi::c_int as mpack_uint32_t as size_t;
    }
    '_c2rust_label_0: {
        if top == lua_gettop(L) {} else {
            __assert_fail(
...
unsafe extern "C" fn lmpack_unpacker_new(mut L: *mut lua_State) -> ::core::ffi::c_int {
    ...
    if lua_gettop(L) > 1 as ::core::ffi::c_int {
        return luaL_error(
            L,
            b"expecting at most 1 table argument\0".as_ptr()
                as *const ::core::ffi::c_char,
        );
    }
    rv = lua_newuserdata(L, ::core::mem::size_of::<Unpacker>()) as *mut Unpacker;
    (*rv).parser = malloc(::core::mem::size_of::<mpack_parser_t>())
        as *mut mpack_parser_t;
    ...
    if lua_type(L, 1 as ::core::ffi::c_int) == LUA_TTABLE {
        ...
        if !(lua_type(L, -1 as ::core::ffi::c_int) == LUA_TNIL) {
            if !(lua_type(L, -1 as ::core::ffi::c_int) == LUA_TTABLE) {
                return luaL_error(
                    L,
                    b"\"ext\" option must be a table\0".as_ptr()
                        as *const ::core::ffi::c_char,
                );
            }
...
unsafe extern "C" fn lmpack_unpacker_delete(
    mut L: *mut lua_State,
) -> ::core::ffi::c_int {
...
unsafe extern "C" fn lmpack_parse_enter(
    ...
    match (*node).tok.type_0 as ::core::ffi::c_uint {
        ...
        6 => {
            '_c2rust_label: {
                if !(*unpacker).string_buffer.is_null() {} else {
                    __assert_fail(
                        b"unpacker->string_buffer\0".as_ptr()
                            as *const ::core::ffi::c_char,
                        b"/home/overlord/projects/neovim/neovim/src/mpack/lmpack.c\0"
                            .as_ptr() as *const ::core::ffi::c_char,
                        321 as ::core::ffi::c_uint,
                        b"void lmpack_parse_enter(mpack_parser_t *, mpack_node_t *)\0"
                            .as_ptr() as *const ::core::ffi::c_char,
                    );
                }
            };
        ...
        9 | 10 | 11 => {
            (*unpacker).string_buffer = malloc((*node).tok.length as size_t)
        ...
        7 | 8 => {
            lua_createtable(L, 0 as ::core::ffi::c_int, 0 as ::core::ffi::c_int);
            (*node).data[0 as ::core::ffi::c_int as usize].i = lmpack_ref(
                L,
                (*unpacker).reg,
            ) as mpack_sintmax_t;
        }
            ...
            < MPACK_TOKEN_BIN as ::core::ffi::c_int as ::core::ffi::c_uint
    {
            ...
            == MPACK_TOKEN_ARRAY as ::core::ffi::c_int as ::core::ffi::c_uint
        {
            ...
            '_c2rust_label: {
                ...
                {} else {
                    __assert_fail(
                        ...
                        b"void lmpack_parse_exit(mpack_parser_t *, mpack_node_t *)\0"
                            .as_ptr() as *const ::core::ffi::c_char,
                    );
                }
            };
            if (*parent).key_visited != 0 {
                lua_pushvalue(L, -2 as ::core::ffi::c_int);
                (*parent).data[1 as ::core::ffi::c_int as usize].i = lmpack_ref(
                    L,
                    (*unpacker).reg,
                ) as mpack_sintmax_t;
            } else {
    ...
    loop {
        ...
        if rv == MPACK_NOMEM as ::core::ffi::c_int {
            ...
            if (*unpacker).parser.is_null() {
                return luaL_error(
                    L,
                    b"failed to grow Unpacker capacity\0".as_ptr()
                        as *const ::core::ffi::c_char,
                );
            }
        }
...
unsafe extern "C" fn lmpack_unpacker_unpack(
    mut L: *mut lua_State,
) -> ::core::ffi::c_int {
    ...
    let mut str_init: *const ::core::ffi::c_char = ::core::ptr::null::<
        ::core::ffi::c_char,
    >();
    ...
    if argc > 3 as ::core::ffi::c_int || argc < 2 as ::core::ffi::c_int {
        return luaL_error(
            L,
            b"expecting between 2 and 3 arguments\0".as_ptr()
                as *const ::core::ffi::c_char,
        );
    }
    ...
    (startpos > 0 as ::core::ffi::c_int as lua_Number
        || luaL_argerror(
            L,
            3 as ::core::ffi::c_int,
            b"start position must be greater than zero\0".as_ptr()
                as *const ::core::ffi::c_char,
        ) != 0) as ::core::ffi::c_int;
    ...
    (startpos as size_t <= len
        || luaL_argerror(
            L,
            3 as ::core::ffi::c_int,
            b"start position must be less than or equal to the input string length\0"
                .as_ptr() as *const ::core::ffi::c_char,
        ) != 0) as ::core::ffi::c_int;
    ...
    '_c2rust_label: {
        if lua_gettop(L) == argc + 2 as ::core::ffi::c_int {} else {
            __assert_fail(
                b"lua_gettop(L) == argc + 2\0".as_ptr() as *const ::core::ffi::c_char,
                b"/home/overlord/projects/neovim/neovim/src/mpack/lmpack.c\0".as_ptr()
                    as *const ::core::ffi::c_char,
                493 as ::core::ffi::c_uint,
                b"int lmpack_unpacker_unpack(lua_State *)\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
        }
    };
...
unsafe extern "C" fn lmpack_unparse_enter(
            ...
            '_c2rust_label: {
                if result != 0 {} else {
                    __assert_fail(
                        ...
                        b"void lmpack_unparse_enter(mpack_parser_t *, mpack_node_t *)\0"
                            .as_ptr() as *const ::core::ffi::c_char,
                    );
                }
            };
    ...
    '_end: {
        match type_0 {
            ...
            LUA_TNUMBER => {
                (*node).tok = mpack_pack_number(
                    lua_tonumber(L, -1 as ::core::ffi::c_int),
                );
                break '_end;
            }
            LUA_TSTRING => {
            ...
            LUA_TTABLE => {
                ...
                let mut has_meta: ::core::ffi::c_int = lua_getmetatable(
                    L,
                    -1 as ::core::ffi::c_int,
                );
                ...
                if (*packer).ext != LUA_NOREF && has_meta != 0 && has_mtdict == 0 {
                    ...
                    if lua_type(L, -1 as ::core::ffi::c_int) == LUA_TFUNCTION {
                        ...
                        if lua_isstring(L, -1 as ::core::ffi::c_int) == 0 {
                            luaL_error(
                                L,
                                b"the second result from ext packer must be a string\0"
                                    .as_ptr() as *const ::core::ffi::c_char,
                            );
                        }
                ...
                loop {
                    ...
                    lmpack_geti(
                        L,
                        (*packer).reg,
                        (*n).data[0 as ::core::ffi::c_int as usize].i
                            as ::core::ffi::c_int,
                    );
                    if lua_rawequal(
                        L,
                ...
                let mut is_array: ::core::ffi::c_int = (has_mtdict == 0)
                    as ::core::ffi::c_int;
                ...
                if is_array != 0 {
                    ...
                    (*node).data[1 as ::core::ffi::c_int as usize].i = LUA_REFNIL
                        as mpack_sintmax_t;
                }
                break '_end;
            }
        ...
        snprintf(
            ...
            50 as size_t,
            b"can't serialize object of type %d\0".as_ptr()
                as *const ::core::ffi::c_char,
            type_0,
        );
        luaL_error(L, &raw mut errmsg as *mut ::core::ffi::c_char);
    }
    (*node).data[0 as ::core::ffi::c_int as usize].i = lmpack_ref(L, (*packer).reg)
        as mpack_sintmax_t;
}
    ...
    loop {
        ...
        if result == MPACK_NOMEM as ::core::ffi::c_int {
            ...
            if (*packer).parser.is_null() {
                return luaL_error(
                    L,
                    b"Failed to grow Packer capacity\0".as_ptr()
                        as *const ::core::ffi::c_char,
                );
            }
        }
...
unsafe extern "C" fn lmpack_session_new(mut L: *mut lua_State) -> ::core::ffi::c_int {
    let mut rv: *mut Session = lua_newuserdata(L, ::core::mem::size_of::<Session>())
        as *mut Session;
    (*rv).session = malloc(::core::mem::size_of::<mpack_rpc_session_t>())
        as *mut mpack_rpc_session_t;
...
unsafe extern "C" fn lmpack_session_receive(
    mut L: *mut lua_State,
) -> ::core::ffi::c_int {
    let mut argc: ::core::ffi::c_int = 0;
    ...
    if done == 0 {
        ...
        match (*session).unpacked.type_0 {
            ...
            6 => {
                lua_pushstring(
                    L,
                    b"notification\0".as_ptr() as *const ::core::ffi::c_char,
                );
                lua_pushnil(L);
            }
            _ => {
                return luaL_error(
                    L,
                    b"invalid msgpack-rpc string\0".as_ptr()
                        as *const ::core::ffi::c_char,
                );
            }
        }
...
unsafe extern "C" fn lmpack_session_request(
    mut L: *mut lua_State,
) -> ::core::ffi::c_int {
    let mut result: ::core::ffi::c_int = 0;
    ...
    loop {
        ...
        if result == MPACK_NOMEM as ::core::ffi::c_int {
            ...
            if (*session).session.is_null() {
                return luaL_error(
                    L,
                    b"Failed to grow Session capacity\0".as_ptr()
                        as *const ::core::ffi::c_char,
                );
            }
        }
    ...
    '_c2rust_label: {
        if result == MPACK_OK as ::core::ffi::c_int {} else {
            __assert_fail(
                b"result == MPACK_OK\0".as_ptr() as *const ::core::ffi::c_char,
                b"/home/overlord/projects/neovim/neovim/src/mpack/lmpack.c\0".as_ptr()
                    as *const ::core::ffi::c_char,
                991 as ::core::ffi::c_uint,
                b"int lmpack_session_request(lua_State *)\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
        }
    };
...
unsafe extern "C" fn lmpack_session_reply(mut L: *mut lua_State) -> ::core::ffi::c_int {
    ...
    (id as size_t as lua_Number == id && id >= 0 as ::core::ffi::c_int as lua_Number
    ...
    '_c2rust_label: {
        if result == MPACK_OK as ::core::ffi::c_int {} else {
            __assert_fail(
                ...
                b"int lmpack_session_reply(lua_State *)\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
        }
    };
    ...
    '_c2rust_label: {
        if result == MPACK_OK as ::core::ffi::c_int {} else {
            __assert_fail(
                ...
                b"int lmpack_session_notify(lua_State *)\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
        }
    };
...
unsafe extern "C" fn lmpack_nil_tostring(mut L: *mut lua_State) -> ::core::ffi::c_int {
    lua_pushfstring(L, NIL_NAME.as_ptr(), lua_topointer(L, 1 as ::core::ffi::c_int));
    return 1 as ::core::ffi::c_int;
}
    ...
    '_c2rust_label: {
        if result == MPACK_OK as ::core::ffi::c_int {} else {
            __assert_fail(
                ...
                b"int lmpack_unpack(lua_State *)\0".as_ptr()
                    as *const ::core::ffi::c_char,
            );
        }
    };
...
static mut mpack_functions: [luaL_Reg; 6] = [
    ...
    luaL_Reg {
        ...
        func: Some(
            lmpack_unpack as unsafe extern "C" fn(*mut lua_State) -> ::core::ffi::c_int,
        ),
    },
    luaL_Reg {
        name: PACK_FN_NAME.as_ptr(),
        func: Some(
            lmpack_pack as unsafe extern "C" fn(*mut lua_State) -> ::core::ffi::c_int,
        ),
    },
    luaL_Reg {
        name: ::core::ptr::null::<::core::ffi::c_char>(),
