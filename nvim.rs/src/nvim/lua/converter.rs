extern "C" {
    ...
    fn decode_create_map_special_dict(
        ret_tv: *mut typval_T,
        len: ptrdiff_t,
    ) -> *mut list_T;
    fn decode_string(
...
pub union C2Rust_Unnamed_1 {
    pub d: C2Rust_Unnamed_5,
    pub l: C2Rust_Unnamed_4,
    pub p: C2Rust_Unnamed_3,
    pub a: C2Rust_Unnamed_2,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn nlua_traverse_table(lstate: *mut lua_State) -> LuaTableProps {
    ...
    if lua_checkstack(lstate, lua_gettop(lstate) + 3 as ::core::ffi::c_int) == 0 {
        semsg(
            gettext(
                b"E1502: Lua failed to grow stack to %i\0".as_ptr()
                    as *const ::core::ffi::c_char,
            ),
    ...
    while lua_next(lstate, -2 as ::core::ffi::c_int) != 0 {
        match lua_type(lstate, -2 as ::core::ffi::c_int) {
            LUA_TSTRING => {
                ...
                let mut s: *const ::core::ffi::c_char = lua_tolstring(
                    lstate,
                    -2 as ::core::ffi::c_int,
                    &raw mut len,
                );
            ...
            LUA_TBOOLEAN => {
                ...
                if b as ::core::ffi::c_int == TYPE_IDX_VALUE {
                    if lua_type(lstate, -1 as ::core::ffi::c_int) == LUA_TNUMBER {
                        let mut n_0: lua_Number = lua_tonumber(
                            lstate,
                            -1 as ::core::ffi::c_int,
                        );
                        if n_0 == kObjectTypeFloat as ::core::ffi::c_int as lua_Number
                            || n_0
                                == kObjectTypeArray as ::core::ffi::c_int as lua_Number
    ...
    if ret.has_type_key {
        ...
        || tsize <= ret.maxidx && other_keys_num == 0 as size_t
            && ret.string_keys_num == 0 as size_t
    {
        ret.type_0 = kObjectTypeArray;
        if tsize == 0 as size_t
            && lua_getmetatable(lstate, -1 as ::core::ffi::c_int) != 0
        {
            nlua_pushref(lstate, (*nlua_global_refs).empty_dict_ref);
            if lua_rawequal(lstate, -2 as ::core::ffi::c_int, -1 as ::core::ffi::c_int)
                != 0
            {
...
pub unsafe extern "C" fn nlua_pop_typval(
    ...
    stack.capacity = ::core::mem::size_of::<[TVPopStackItem; 2]>()
        ...
        .wrapping_div(
            (::core::mem::size_of::<[TVPopStackItem; 2]>()
                .wrapping_rem(::core::mem::size_of::<TVPopStackItem>()) == 0)
                ...
                )
        {
            (if stack.items == &raw mut stack.init_array as *mut TVPopStackItem {
                ...
                _memcpy_free(
                    ...
                    stack.items as *mut ::core::ffi::c_void,
                    stack.size.wrapping_mul(::core::mem::size_of::<TVPopStackItem>()),
                )
            })
        } else {
            (if stack.items == &raw mut stack.init_array as *mut TVPopStackItem {
                ...
                xrealloc(
                    stack.items as *mut ::core::ffi::c_void,
                    stack.capacity.wrapping_mul(::core::mem::size_of::<TVPopStackItem>()),
                )
            })
    ...
    *stack.items.offset(c2rust_fresh0 as isize) = TVPopStackItem {
            ...
            if cur.container {
                        ...
                        == VAR_DICT as ::core::ffi::c_int as ::core::ffi::c_uint
                {
                    '_c2rust_label: {
                        ...
                        {} else {
                            __assert_fail(
                                b"cur.tv->v_type == (cur.special ? VAR_LIST : VAR_DICT)\0"
                                    .as_ptr() as *const ::core::ffi::c_char,
                                b"/home/overlord/projects/neovim/neovim/src/nvim/lua/converter.c\0"
                                    .as_ptr() as *const ::core::ffi::c_char,
                    ...
                    if next_key_found {
                        ...
                        if cur.special {
                            ...
                            let mut s_tv: typval_T = decode_string(
                                s,
                                len,
                                true_0 != 0,
                                false_0 != 0,
                        ...
                        *stack.items.offset(c2rust_fresh3 as isize) = cur;
                        cur = TVPopStackItem {
                            tv: &raw mut (*(tv_list_last
                                as unsafe extern "C" fn(
                                    *const list_T,
                                ) -> *mut listitem_T)((*cur.tv).vval.v_list))
                                .li_tv,
                            list_len: 0,
                            container: false,
                            special: false,
            ...
            's_523: {
                match lua_type(lstate, -1 as ::core::ffi::c_int) {
                    ...
                    LUA_TBOOLEAN => {
                        ...
                        (*cur.tv).vval.v_bool = (if lua_toboolean(
                            lstate,
                            -1 as ::core::ffi::c_int,
                        ) != 0
                        {
                    ...
                    LUA_TSTRING => {
                        ...
                        let mut s_0: *const ::core::ffi::c_char = lua_tolstring(
                            lstate,
                            -1 as ::core::ffi::c_int,
                            &raw mut len_0,
                        );
                    ...
                    LUA_TTABLE => {
                        ...
                        while i < stack.size {
                            ...
                            if item.container as ::core::ffi::c_int != 0
                                && lua_rawequal(lstate, -1 as ::core::ffi::c_int, item.idx)
                                    != 0
                            {
                        ...
                        match table_props.type_0 as ::core::ffi::c_uint {
                            5 => {
                                ...
                                (*cur.tv).vval.v_list = tv_list_alloc(
                                    table_props.maxidx as ptrdiff_t,
                                );
                    ...
                    LUA_TFUNCTION => {
                        let mut func: LuaRef = nlua_ref_global(
                            lstate,
                            -1 as ::core::ffi::c_int,
                        );
                    ...
                    LUA_TUSERDATA => {
                        ...
                        if is_nil {
                            ...
                            emsg(
                                gettext(
                                    b"E5101: Cannot convert given Lua type\0".as_ptr()
                                        as *const ::core::ffi::c_char,
                                ),
                            );
                            ret = false_0 != 0;
    ...
    '_c2rust_label_5: {
        if lua_gettop(lstate) == initial_size - 1 as ::core::ffi::c_int {} else {
            __assert_fail(
...
pub unsafe extern "C" fn nlua_push_Dict(
    ...
    lua_createtable(lstate, 0 as ::core::ffi::c_int, dict.size as ::core::ffi::c_int);
    ...
    while i < dict.size {
        ...
        nlua_push_Object(lstate, &raw mut (*dict.items.offset(i as isize)).value, flags);
        lua_rawset(lstate, -3 as ::core::ffi::c_int);
        i = i.wrapping_add(1);
    }
}
...
pub unsafe extern "C" fn nlua_push_Array(
    ...
    lua_createtable(lstate, array.size as ::core::ffi::c_int, 0 as ::core::ffi::c_int);
    let mut i: size_t = 0 as size_t;
    while i < array.size {
...
pub unsafe extern "C" fn nlua_pop_Integer(
    ...
    lua_settop(lstate, -1 as ::core::ffi::c_int - 1 as ::core::ffi::c_int);
    if n > API_INTEGER_MAX as lua_Number || n < API_INTEGER_MIN as lua_Number
...
unsafe extern "C" fn nlua_check_type(
    ...
    if type_0 as ::core::ffi::c_uint
        ...
        && table_props.type_0 as ::core::ffi::c_uint
            == kObjectTypeArray as ::core::ffi::c_int as ::core::ffi::c_uint
        && table_props.maxidx == 0 as size_t && !table_props.has_type_key
    {
    ...
    stack.capacity = ::core::mem::size_of::<[ObjPopStackItem; 2]>()
        ...
        .wrapping_div(
            (::core::mem::size_of::<[ObjPopStackItem; 2]>()
                .wrapping_rem(::core::mem::size_of::<ObjPopStackItem>()) == 0)
                as ::core::ffi::c_int as usize,
        ) as size_t;
    stack.size = 0 as size_t;
            ...
            (if stack.items == &raw mut stack.init_array as *mut ObjPopStackItem {
                ...
                _memcpy_free(
                    &raw mut stack.init_array as *mut ObjPopStackItem
                        as *mut ::core::ffi::c_void,
                    stack.items as *mut ::core::ffi::c_void,
                    stack.size.wrapping_mul(::core::mem::size_of::<ObjPopStackItem>()),
                )
            })
        } else {
            (if stack.items == &raw mut stack.init_array as *mut ObjPopStackItem {
                ...
                == kObjectTypeDict as ::core::ffi::c_int as ::core::ffi::c_uint
            {
                if (*cur.obj).data.dict.size == (*cur.obj).data.dict.capacity {
                    ...
                    if next_key_found {
                        ...
                        (*cur.obj).data.dict.size = (*cur.obj)
                            .data
                            .dict
                            .size
                            .wrapping_add(1);
                    ...
                    match table_props.type_0 as ::core::ffi::c_uint {
                        5 => {
                            *cur.obj = object {
                            ...
                            if table_props.maxidx != 0 as size_t {
                                (*cur.obj).data.array = arena_array(
                                    arena,
                                    table_props.maxidx,
                                );
                                cur.container = true_0 != 0;
                                '_c2rust_label_0: {
                                    if stack.size < 18446744073709551615 as size_t {} else {
                                        __assert_fail(
                    ...
                    if is_nil {
                        *cur.obj = object {
                        ...
                        api_set_error(
                            err,
                            kErrorTypeValidation,
                            b"Cannot convert userdata\0".as_ptr()
                                as *const ::core::ffi::c_char,
                        );
                    }
                    break 's_341;
...
pub unsafe extern "C" fn nlua_pop_keydict(
    ...
    while lua_next(L, -2 as ::core::ffi::c_int) != 0 {
        ...
        let mut field: *mut KeySetLink = hashy
            .expect("non-null function pointer")(s, len);
        if field.is_null() {
            api_set_error(
                err,
                kErrorTypeValidation,
        ...
        if (*field).type_0 == kObjectTypeNil as ::core::ffi::c_int {
            *(mem as *mut Object) = nlua_pop_Object(L, true_0 != 0, arena, err);
                ...
                && lua_type(L, -1 as ::core::ffi::c_int) == LUA_TSTRING
            {
                ...
                let mut name: *const ::core::ffi::c_char = lua_tolstring(
                    L,
                    -1 as ::core::ffi::c_int,
                    &raw mut name_len,
                );
...
#[no_mangle]
pub static mut _typval_encode_lua_nodict_var: *const dict_T = ::core::ptr::null::<
    dict_T,
>();
#[inline(always)]
    ...
    if *val_copyID == copyID {
        ...
        while backref != 0 {
            ...
            if mpval.type_0 as ::core::ffi::c_uint == conv_type as ::core::ffi::c_uint {
                ...
                {
                    (mpval.data.d.dict as *mut ::core::ffi::c_void == val)
                        as ::core::ffi::c_int
                } else {
                    (mpval.data.l.list as *mut ::core::ffi::c_void == val)
                        as ::core::ffi::c_int
                } != 0
                {
                    lua_pushvalue(
                        ...
                        -((*mpstack)
                            ...
                            .wrapping_mul(2 as size_t) as ::core::ffi::c_int),
                    );
                    break;
                }
            }
...
unsafe extern "C" fn _typval_encode_lua_convert_one_value(
    ...
    '_typval_encode_stop_converting_one_item: {
        match (*tv).v_type as ::core::ffi::c_uint {
                                ...
                                match i as MessagePackType as ::core::ffi::c_uint {
                                    ...
                                    1 => {
                                            ...
                                            == VAR_NUMBER as ::core::ffi::c_int as ::core::ffi::c_uint
                                        {
                                            lua_pushboolean(
                                                lstate,
                                                ((*val_di).di_tv.vval.v_number != 0) as ::core::ffi::c_int,
                                            );
                                            break '_typval_encode_stop_converting_one_item;
                                        }
                                    }
                                                        ...
                                                        })
                                                    {
                                                            ...
                                                            })
                                                        {
                                                            ...
                                                            if sign > 0 as varnumber_T {
                                                                lua_pushnumber(lstate, number as lua_Number);
                                                            } else {
                                                                lua_pushnumber(lstate, number.wrapping_neg() as lua_Number);
                                                            }
                                                            break '_typval_encode_stop_converting_one_item;
                                                        }
                                                    }
                                    ...
                                    5 => {
                                            ...
                                            == VAR_LIST as ::core::ffi::c_int as ::core::ffi::c_uint
                                        {
                                            ...
                                            let te_csr_ret_0: ::core::ffi::c_int = _typval_encode_lua_check_self_reference(
                                                lstate,
                                            ...
                                            (*mpstack).size = (*mpstack).size.wrapping_add(1);
                                            *(*mpstack).items.offset(c2rust_fresh11 as isize) = MPConvStackVal {
                                                type_0: kMPConvList,
                                                tv: tv,
                                    ...
                                    6 => {
                                            ...
                                            == VAR_LIST as ::core::ffi::c_int as ::core::ffi::c_uint
                                        {
                                                ...
                                                || tv_list_len(val_list_0) == 0 as ::core::ffi::c_int
                                            {
                                                ...
                                                let te_csr_ret_1: ::core::ffi::c_int = _typval_encode_lua_check_self_reference(
                                                    lstate,
                                                ...
                                                (*mpstack).size = (*mpstack).size.wrapping_add(1);
                                                *(*mpstack).items.offset(c2rust_fresh12 as isize) = MPConvStackVal {
                                                    type_0: kMPConvPairs,
                                                    tv: tv,
            ...
            0 => {
                internal_error(
                    b"_typval_encode_lua_convert_one_value()\0".as_ptr()
                        as *const ::core::ffi::c_char,
                );
                return FAIL;
            }
                ...
                match (*cur_mpsv).type_0 as ::core::ffi::c_uint {
                    ...
                    1 => {
                        if (*cur_mpsv).data.l.li.is_null() {
                            ...
                            {
                                let mut idx: lua_Number = lua_tonumber(
                                    lstate,
                                    -2 as ::core::ffi::c_int,
                                );
                                lua_rawset(lstate, -3 as ::core::ffi::c_int);
                                lua_pushnumber(
                                    lstate,
                                    idx + 1 as ::core::ffi::c_int as lua_Number,
                                );
                            }
                    ...
                    4 => {
                        if (*cur_mpsv).data.a.todo == 0 {
                            ...
                            if (*cur_mpsv).data.a.argv != (*cur_mpsv).data.a.arg {
                                let mut idx_0: lua_Number = lua_tonumber(
                                    lstate,
                                    -2 as ::core::ffi::c_int,
                                );
                                lua_rawset(lstate, -3 as ::core::ffi::c_int);
