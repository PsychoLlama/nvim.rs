...
pub unsafe extern "C" fn base64_encode(
    ...
    let mut dest: *mut ::core::ffi::c_char = xmalloc(out_len.wrapping_add(1 as size_t))
    ...
    while src_i.wrapping_add(7 as size_t) < src_len {
        ...
        *dest.offset(out_i.wrapping_add(0 as size_t) as isize) = alphabet[(bits_be
            >> 58 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
        *dest.offset(out_i.wrapping_add(1 as size_t) as isize) = alphabet[(bits_be
            >> 52 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
        *dest.offset(out_i.wrapping_add(2 as size_t) as isize) = alphabet[(bits_be
            >> 46 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
        *dest.offset(out_i.wrapping_add(3 as size_t) as isize) = alphabet[(bits_be
            >> 40 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
        *dest.offset(out_i.wrapping_add(4 as size_t) as isize) = alphabet[(bits_be
            >> 34 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
        *dest.offset(out_i.wrapping_add(5 as size_t) as isize) = alphabet[(bits_be
            >> 28 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
        *dest.offset(out_i.wrapping_add(6 as size_t) as isize) = alphabet[(bits_be
            >> 22 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
        *dest.offset(out_i.wrapping_add(7 as size_t) as isize) = alphabet[(bits_be
            >> 16 as ::core::ffi::c_int & 0x3f as uint64_t) as usize];
    ...
    while src_i.wrapping_add(3 as size_t) < src_len {
        ...
        *dest.offset(out_i.wrapping_add(0 as size_t) as isize) = alphabet[(bits_be_0
            >> 26 as ::core::ffi::c_int & 0x3f as uint32_t) as usize];
        *dest.offset(out_i.wrapping_add(1 as size_t) as isize) = alphabet[(bits_be_0
            >> 20 as ::core::ffi::c_int & 0x3f as uint32_t) as usize];
        *dest.offset(out_i.wrapping_add(2 as size_t) as isize) = alphabet[(bits_be_0
            >> 14 as ::core::ffi::c_int & 0x3f as uint32_t) as usize];
        *dest.offset(out_i.wrapping_add(3 as size_t) as isize) = alphabet[(bits_be_0
            >> 8 as ::core::ffi::c_int & 0x3f as uint32_t) as usize];
        out_i = (out_i as ::core::ffi::c_ulong)
    ...
    if src_i.wrapping_add(2 as size_t) < src_len {
        *dest.offset(out_i.wrapping_add(0 as size_t) as isize) = alphabet[(*s
            .offset(src_i as isize) as ::core::ffi::c_int >> 2 as ::core::ffi::c_int)
            as usize];
        *dest.offset(out_i.wrapping_add(1 as size_t) as isize) = alphabet[((*s
            .offset(src_i as isize) as ::core::ffi::c_int & 0x3 as ::core::ffi::c_int)
            << 4 as ::core::ffi::c_int
            | *s.offset(src_i.wrapping_add(1 as size_t) as isize) as ::core::ffi::c_int
                >> 4 as ::core::ffi::c_int) as usize];
        *dest.offset(out_i.wrapping_add(2 as size_t) as isize) = alphabet[((*s
            .offset(src_i.wrapping_add(1 as size_t) as isize) as ::core::ffi::c_int
        ...
        *dest.offset(out_i.wrapping_add(3 as size_t) as isize) = alphabet[(*s
            .offset(src_i.wrapping_add(2 as size_t) as isize) as ::core::ffi::c_int
        ...
        *dest.offset(out_i.wrapping_add(2 as size_t) as isize) = alphabet[((*s
            .offset(src_i.wrapping_add(1 as size_t) as isize) as ::core::ffi::c_int
            & 0xf as ::core::ffi::c_int) << 2 as ::core::ffi::c_int) as usize];
...
pub unsafe extern "C" fn base64_decode(
    ...
    let mut dest: *mut ::core::ffi::c_char = ::core::ptr::null_mut::<
        ::core::ffi::c_char,
    >();
    '_invalid: {
        if src_len.wrapping_rem(4 as size_t) == 0 as size_t {
            ...
            if src_len >= 1 as size_t
                && *src.offset(src_len.wrapping_sub(1 as size_t) as isize)
                    as ::core::ffi::c_int == '=' as ::core::ffi::c_int
            {
                out_len = out_len.wrapping_sub(1);
            }
            if src_len >= 2 as size_t
                && *src.offset(src_len.wrapping_sub(2 as size_t) as isize)
                    as ::core::ffi::c_int == '=' as ::core::ffi::c_int
            {
                out_len = out_len.wrapping_sub(1);
            }
            ...
            while src_i < src_len {
                ...
                if d as ::core::ffi::c_int == 0 as ::core::ffi::c_int {
                    ...
                    if acc_len >= 8 as ::core::ffi::c_int {
                        ...
                        *dest.offset(out_i as isize) = (acc >> acc_len)
                            as ::core::ffi::c_char;
                    ...
                    != 0 as ::core::ffi::c_int)
            {
                if leftover_i > -1 as ::core::ffi::c_int {
                    let mut padding_len: ::core::ffi::c_int = acc_len
                        / 2 as ::core::ffi::c_int;
