...
const CLASS_OPCODES: [c_int; 19] = [
    NfaOp::ClassAlnum.code(),
    NfaOp::ClassAlpha.code(),
    NfaOp::ClassBlank.code(),
    NfaOp::ClassCntrl.code(),
    NfaOp::ClassDigit.code(),
    NfaOp::ClassGraph.code(),
    NfaOp::ClassLower.code(),
    NfaOp::ClassPrint.code(),
    NfaOp::ClassPunct.code(),
    NfaOp::ClassSpace.code(),
    NfaOp::ClassUpper.code(),
    NfaOp::ClassXdigit.code(),
    NfaOp::ClassTab.code(),
    NfaOp::ClassReturn.code(),
    NfaOp::ClassBackspace.code(),
    NfaOp::ClassEscape.code(),
    NfaOp::ClassIdent.code(),
...
/// `accepts_newline` is set for the `\_[` form, which also matches a line
/// break.
///
