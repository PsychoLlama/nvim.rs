...
use crate::ex_docmd::{
    ...
    FIND_IDENT, FIND_STRING, FNAME_HYP, FNAME_MESS, MAXPATHL, VALID_HEAD, VALID_PATH,
...
use crate::types::{
    ...
    FAIL, NUL, OK, VV_OLDFILES, exarg_T, expand_T, linenr_T, size_t, ssize_t, uint8_t, uint32_t,
};
