...
use crate::ex_docmd::{
    ...
    IOSIZE, PROF_YES, cmdnames, e_ambiguous_use_of_user_defined_command, e_not_an_editor_command,
...
use crate::types::{
    ...
    CMD_vglobal, CMD_while, CMD_wincmd, CMD_write, FAIL, LineGetter, NUL, cmdidx_T, cmdmod_T,
    cstack_T, exarg_T, size_t, uint8_t, uint32_t,
};
