...
use crate::ex_docmd::{
    CCGD_AW, CCGD_EXCMD, CCGD_FORCEIT, DOBUF_DEL, DOBUF_UNLOAD, DOBUF_WIPE, EXIT_FAILURE, NUL,
};
...
use crate::types::{
    ...
    CMD_wq, CMOD_CONFIRM, FAIL, Integer, OK, VV_EXITREASON, buf_T, bufref_T, exarg_T, linenr_T,
