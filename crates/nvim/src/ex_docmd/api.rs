...
use crate::ex_docmd::{
    ...
    EX_MODIFY, EX_RANGE, EX_TRLBAR, EX_WHOLEFOLD, EX_XFILE, IOSIZE, cmdnames,
...
use crate::types::{
    ...
    CMD_iput, CMD_put, CMD_read, CMD_try, CmdParseInfo, FAIL, NUL, OK, cmdmod_T, cstack_T, exarg_T,
