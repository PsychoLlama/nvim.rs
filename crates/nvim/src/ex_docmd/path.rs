...
use crate::ex_docmd::{
    CPO_NOSYMLINKS, MAXPATHL, OPT_GLOBAL, OPT_LOCAL, ffu_cb, kCdCauseManual, prev_dir,
};
...
use crate::types::{
    BoolVarValue, CMD_lcd, CMD_lchdir, CMD_tcd, CMD_tchdir, Callback, CdScope, FAIL, NUL, OK,
    OptInt, VAR_BOOL, VAR_LIST, VAR_STRING, VAR_UNKNOWN, VAR_UNLOCKED, buf_T, exarg_T,
