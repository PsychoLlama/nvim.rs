...
use crate::ex_docmd::{CPO_NOSYMLINKS, OPT_GLOBAL, OPT_LOCAL, ffu_cb, kCdCauseManual, prev_dir};
...
use crate::types::{
    ...
    OK, OptInt, VAR_BOOL, VAR_LIST, VAR_STRING, VAR_UNKNOWN, VAR_UNLOCKED, buf_T, exarg_T,
