...
use crate::types::{
    AdditionalData, FAIL, OK, OptInt, OptVal, OptValData, String_0, buf_T, colnr_T, fmark_T,
...
use super::{
    B_IMODE_LMAP, B_IMODE_NONE, B_IMODE_USE_INSERT, COM_ALL, CPO_VI, EOL_MAC, FO_ALL, NUL,
    OPT_GLOBAL, OPT_LOCAL, SID_NONE, did_set_opt_flags, did_set_optexpr, did_set_option_listflag,
