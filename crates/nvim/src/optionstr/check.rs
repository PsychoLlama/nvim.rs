...
pub unsafe fn check_buf_options(buffer: *mut Buffer) {
    ...
    for field in [
        unsafe { &raw mut (*buffer).b_p_bh },
        unsafe { &raw mut (*buffer).b_p_bt },
        unsafe { &raw mut (*buffer).b_p_fenc },
        unsafe { &raw mut (*buffer).b_p_ff },
        unsafe { &raw mut (*buffer).b_p_def },
        unsafe { &raw mut (*buffer).b_p_inc },
        unsafe { &raw mut (*buffer).b_p_inex },
        unsafe { &raw mut (*buffer).b_p_inde },
        unsafe { &raw mut (*buffer).b_p_indk },
        unsafe { &raw mut (*buffer).b_p_fp },
        unsafe { &raw mut (*buffer).b_p_fex },
        unsafe { &raw mut (*buffer).b_p_kp },
        unsafe { &raw mut (*buffer).b_p_mps },
        unsafe { &raw mut (*buffer).b_p_fo },
        unsafe { &raw mut (*buffer).b_p_flp },
        unsafe { &raw mut (*buffer).b_p_isk },
        unsafe { &raw mut (*buffer).b_p_com },
        unsafe { &raw mut (*buffer).b_p_cms },
        unsafe { &raw mut (*buffer).b_p_nf },
        unsafe { &raw mut (*buffer).b_p_qe },
        unsafe { &raw mut (*buffer).b_p_syn },
        unsafe { &raw mut (*buffer).b_s.b_syn_isk },
        unsafe { &raw mut (*buffer).b_s.b_p_spc },
        unsafe { &raw mut (*buffer).b_s.b_p_spf },
        unsafe { &raw mut (*buffer).b_s.b_p_spl },
        unsafe { &raw mut (*buffer).b_s.b_p_spo },
        unsafe { &raw mut (*buffer).b_p_sua },
        unsafe { &raw mut (*buffer).b_p_cink },
        unsafe { &raw mut (*buffer).b_p_cino },
    ] {
        unsafe { check_string_option(field) };
    }
    unsafe { parse_cino(Buf::new(buffer)) };
    for field in [
        unsafe { &raw mut (*buffer).b_p_lop },
        unsafe { &raw mut (*buffer).b_p_ft },
        unsafe { &raw mut (*buffer).b_p_cinw },
        unsafe { &raw mut (*buffer).b_p_cinsd },
        unsafe { &raw mut (*buffer).b_p_cot },
        unsafe { &raw mut (*buffer).b_p_cpt },
        unsafe { &raw mut (*buffer).b_p_cfu },
        unsafe { &raw mut (*buffer).b_p_ofu },
        unsafe { &raw mut (*buffer).b_p_keymap },
        unsafe { &raw mut (*buffer).b_p_gefm },
        unsafe { &raw mut (*buffer).b_p_gp },
        unsafe { &raw mut (*buffer).b_p_mp },
        unsafe { &raw mut (*buffer).b_p_efm },
        unsafe { &raw mut (*buffer).b_p_ep },
        unsafe { &raw mut (*buffer).b_p_path },
        unsafe { &raw mut (*buffer).b_p_tags },
        unsafe { &raw mut (*buffer).b_p_ffu },
        unsafe { &raw mut (*buffer).b_p_tfu },
        unsafe { &raw mut (*buffer).b_p_tc },
        unsafe { &raw mut (*buffer).b_p_dict },
        unsafe { &raw mut (*buffer).b_p_dia },
        unsafe { &raw mut (*buffer).b_p_tsr },
        unsafe { &raw mut (*buffer).b_p_tsrfu },
        unsafe { &raw mut (*buffer).b_p_lw },
        unsafe { &raw mut (*buffer).b_p_bkc },
        unsafe { &raw mut (*buffer).b_p_menc },
        unsafe { &raw mut (*buffer).b_p_vsts },
        unsafe { &raw mut (*buffer).b_p_vts },
    ] {
        unsafe { check_string_option(field) };
    }
}
