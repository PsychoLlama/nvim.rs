...
pub(crate) const NV_CMDS: [NvCmd; 188] = [
    cmd(NUL, nv_error, 0, 0),
    cmd(Ctrl_A, nv_addsub, 0, 0),
    cmd(Ctrl_B, nv_page, NV_STS, BACKWARD as c_int),
    cmd(Ctrl_C, nv_esc, 0, 1),
    cmd(Ctrl_D, nv_halfpage, 0, 0),
    cmd(Ctrl_E, nv_scroll_line, 0, 1),
    cmd(Ctrl_F, nv_page, NV_STS, FORWARD as c_int),
    cmd(Ctrl_G, nv_ctrlg, 0, 0),
    cmd(Ctrl_H, nv_ctrlh, 0, 0),
    cmd(Ctrl_I, nv_pcmark, 0, 0),
    cmd(NL, nv_down, 0, 0),
    cmd(Ctrl_K, nv_error, 0, 0),
    cmd(Ctrl_L, nv_clear, 0, 0),
    cmd(CAR, nv_down, 0, 1),
    cmd(Ctrl_N, nv_down, NV_STS, 0),
    cmd(Ctrl_O, nv_ctrlo, 0, 0),
    cmd(Ctrl_P, nv_up, NV_STS, 0),
    cmd(Ctrl_Q, nv_visual, 0, 0),
    cmd(Ctrl_R, nv_redo_or_register, 0, 0),
    cmd(Ctrl_S, nv_ignore, 0, 0),
    cmd(Ctrl_T, nv_tagpop, NV_NCW, 0),
    cmd(Ctrl_U, nv_halfpage, 0, 0),
    cmd(Ctrl_V, nv_visual, 0, 0),
    cmd('V' as c_int, nv_visual, 0, 0),
    cmd('v' as c_int, nv_visual, 0, 0),
    cmd(Ctrl_W, nv_window, 0, 0),
    cmd(Ctrl_X, nv_addsub, 0, 0),
    cmd(Ctrl_Y, nv_scroll_line, 0, 0),
    cmd(Ctrl_Z, nv_suspend, 0, 0),
    cmd(ESC, nv_esc, 0, 0),
    cmd(Ctrl_BSL, nv_normal, NV_NCH_ALW, 0),
    cmd(Ctrl_RSB, nv_ident, NV_NCW, 0),
    cmd(Ctrl_HAT, nv_hat, NV_NCW, 0),
    cmd(Ctrl__, nv_error, 0, 0),
    cmd(' ' as c_int, nv_right, 0, 0),
    cmd('!' as c_int, nv_operator, 0, 0),
    cmd('"' as c_int, nv_regname, NV_NCH_NOP | NV_KEEPREG, 0),
    cmd('#' as c_int, nv_ident, 0, 0),
    cmd('$' as c_int, nv_dollar, 0, 0),
    cmd('%' as c_int, nv_percent, 0, 0),
    cmd('&' as c_int, nv_optrans, 0, 0),
    cmd('\'' as c_int, nv_gomark, NV_NCH_ALW, 1),
    cmd('(' as c_int, nv_brace, 0, BACKWARD as c_int),
    cmd(')' as c_int, nv_brace, 0, FORWARD as c_int),
    cmd('*' as c_int, nv_ident, 0, 0),
    cmd('+' as c_int, nv_down, 0, 1),
    cmd(',' as c_int, nv_csearch, 0, 1),
    cmd('-' as c_int, nv_up, 0, 1),
    cmd('.' as c_int, nv_dot, NV_KEEPREG, 0),
    cmd('/' as c_int, nv_search, 0, 0),
    cmd('0' as c_int, nv_beginline, 0, 0),
    cmd('1' as c_int, nv_ignore, 0, 0),
    cmd('2' as c_int, nv_ignore, 0, 0),
    cmd('3' as c_int, nv_ignore, 0, 0),
    cmd('4' as c_int, nv_ignore, 0, 0),
    cmd('5' as c_int, nv_ignore, 0, 0),
    cmd('6' as c_int, nv_ignore, 0, 0),
    cmd('7' as c_int, nv_ignore, 0, 0),
    cmd('8' as c_int, nv_ignore, 0, 0),
    cmd('9' as c_int, nv_ignore, 0, 0),
    cmd(':' as c_int, nv_colon, 0, 0),
    cmd(';' as c_int, nv_csearch, 0, 0),
    cmd('<' as c_int, nv_operator, NV_RL, 0),
    cmd('=' as c_int, nv_operator, 0, 0),
    cmd('>' as c_int, nv_operator, NV_RL, 0),
    cmd('?' as c_int, nv_search, 0, 0),
    cmd('@' as c_int, nv_at, NV_NCH_NOP, 0),
    cmd('A' as c_int, nv_edit, 0, 0),
    cmd('B' as c_int, nv_bck_word, 0, 1),
    cmd('C' as c_int, nv_abbrev, NV_KEEPREG, 0),
    cmd('D' as c_int, nv_abbrev, NV_KEEPREG, 0),
    cmd('E' as c_int, nv_wordcmd, 0, 1),
    cmd(
        'F' as c_int,
        nv_csearch,
        NV_NCH_ALW | NV_LANG,
    ...
    cmd('G' as c_int, nv_goto, 0, 1),
    cmd('H' as c_int, nv_scroll, 0, 0),
    cmd('I' as c_int, nv_edit, 0, 0),
    cmd('J' as c_int, nv_join, 0, 0),
    cmd('K' as c_int, nv_ident, 0, 0),
    cmd('L' as c_int, nv_scroll, 0, 0),
    cmd('M' as c_int, nv_scroll, 0, 0),
    cmd('N' as c_int, nv_next, 0, SEARCH_REV as c_int),
    cmd('O' as c_int, nv_open, 0, 0),
    cmd('P' as c_int, nv_put, 0, 0),
    cmd('Q' as c_int, nv_regreplay, 0, 0),
    cmd('R' as c_int, nv_replace_mode, 0, 0),
    cmd('S' as c_int, nv_subst, NV_KEEPREG, 0),
    cmd(
        'T' as c_int,
        nv_csearch,
        NV_NCH_ALW | NV_LANG,
    ...
    cmd('U' as c_int, nv_undo_line, 0, 0),
    cmd('W' as c_int, nv_wordcmd, 0, 1),
    cmd('X' as c_int, nv_abbrev, NV_KEEPREG, 0),
    cmd('Y' as c_int, nv_abbrev, NV_KEEPREG, 0),
    cmd('Z' as c_int, nv_exit_command, NV_NCH_NOP | NV_NCW, 0),
    cmd('[' as c_int, nv_brackets, NV_NCH_ALW, BACKWARD as c_int),
    cmd('\\' as c_int, nv_error, 0, 0),
    cmd(']' as c_int, nv_brackets, NV_NCH_ALW, FORWARD as c_int),
    cmd(
        '^' as c_int,
        nv_beginline,
        0,
    ...
    cmd('_' as c_int, nv_lineop, 0, 0),
    cmd('`' as c_int, nv_gomark, NV_NCH_ALW, 0),
    cmd('a' as c_int, nv_edit, NV_NCH, 0),
    cmd('b' as c_int, nv_bck_word, 0, 0),
    cmd('c' as c_int, nv_operator, 0, 0),
    cmd('d' as c_int, nv_operator, 0, 0),
    cmd('e' as c_int, nv_wordcmd, 0, 0),
    cmd(
        'f' as c_int,
        nv_csearch,
        NV_NCH_ALW | NV_LANG,
    ...
    cmd('g' as c_int, nv_g_cmd, NV_NCH_ALW, 0),
    cmd('h' as c_int, nv_left, NV_RL, 0),
    cmd('i' as c_int, nv_edit, NV_NCH, 0),
    cmd('j' as c_int, nv_down, 0, 0),
    cmd('k' as c_int, nv_up, 0, 0),
    cmd('l' as c_int, nv_right, NV_RL, 0),
    cmd('m' as c_int, nv_mark, NV_NCH_NOP, 0),
    cmd('n' as c_int, nv_next, 0, 0),
    cmd('o' as c_int, nv_open, 0, 0),
    cmd('p' as c_int, nv_put, 0, 0),
    cmd('q' as c_int, nv_record, NV_NCH, 0),
    cmd('r' as c_int, nv_replace, NV_NCH_NOP | NV_LANG, 0),
    cmd('s' as c_int, nv_subst, NV_KEEPREG, 0),
    cmd(
        't' as c_int,
        nv_csearch,
    ...
    cmd('u' as c_int, nv_undo, 0, 0),
    cmd('w' as c_int, nv_wordcmd, 0, 0),
    cmd('x' as c_int, nv_abbrev, NV_KEEPREG, 0),
    cmd('y' as c_int, nv_operator, 0, 0),
    cmd('z' as c_int, nv_zet, NV_NCH_ALW, 0),
    cmd('{' as c_int, nv_findpar, 0, BACKWARD as c_int),
    cmd('|' as c_int, nv_pipe, 0, 0),
    cmd('}' as c_int, nv_findpar, 0, FORWARD as c_int),
    cmd('~' as c_int, nv_tilde, 0, 0),
    cmd(POUND, nv_ident, 0, 0),
    cmd(
    ...
    cmd(Key::Bs.code(), nv_ctrlh, 0, 0),
    cmd(Key::Up.code(), nv_up, NV_SSS | NV_STS, 0),
    cmd(
    ...
    cmd(Key::Down.code(), nv_down, NV_SSS | NV_STS, 0),
    cmd(
    ...
    cmd(Key::Left.code(), nv_left, NV_SSS | NV_STS | NV_RL, 0),
    cmd(Key::SLeft.code(), nv_bck_word, NV_SS | NV_RL, 0),
    cmd(
    ...
    cmd(Key::Right.code(), nv_right, NV_SSS | NV_STS | NV_RL, 0),
    cmd(Key::SRight.code(), nv_wordcmd, NV_SS | NV_RL, 0),
    cmd(
    ...
    cmd(Key::End.code(), nv_end, NV_SSS | NV_STS, 0),
    cmd(Key::Kend.code(), nv_end, NV_SSS | NV_STS, 0),
    cmd(Key::SEnd.code(), nv_end, NV_SS, 0),
    cmd(
    ...
    cmd(Key::Home.code(), nv_home, NV_SSS | NV_STS, 0),
    cmd(Key::Khome.code(), nv_home, NV_SSS | NV_STS, 0),
    cmd(Key::SHome.code(), nv_home, NV_SS, 0),
    cmd(
    ...
    cmd(Key::Del.code(), nv_abbrev, 0, 0),
    cmd(
    ...
    cmd(Key::Undo.code(), nv_kundo, 0, 0),
    cmd(Key::Help.code(), nv_help, NV_NCW, 0),
    cmd(Key::F1.code(), nv_help, NV_NCW, 0),
    cmd(
    ...
    cmd(Key::Select.code(), nv_select, 0, 0),
    cmd(Key::PasteStart.code(), nv_paste, NV_KEEPREG, 0),
    cmd(
