...
pub(crate) const NV_CMDS: [nv_cmd; 188] = [
    ...
    cmd(Key::Ins.code(), Some(nv_edit), 0, 0),
    cmd(
    ...
    cmd(Key::Bs.code(), Some(nv_ctrlh), 0, 0),
    cmd(Key::Up.code(), Some(nv_up), NV_SSS | NV_STS, 0),
    cmd(
    ...
    cmd(Key::Down.code(), Some(nv_down), NV_SSS | NV_STS, 0),
    cmd(
    ...
    cmd(Key::Left.code(), Some(nv_left), NV_SSS | NV_STS | NV_RL, 0),
    cmd(Key::SLeft.code(), Some(nv_bck_word), NV_SS | NV_RL, 0),
    cmd(
    ...
    cmd(Key::SRight.code(), Some(nv_wordcmd), NV_SS | NV_RL, 0),
    cmd(
    ...
    cmd(Key::End.code(), Some(nv_end), NV_SSS | NV_STS, 0),
    cmd(Key::Kend.code(), Some(nv_end), NV_SSS | NV_STS, 0),
    cmd(Key::SEnd.code(), Some(nv_end), NV_SS, 0),
    cmd(
    ...
    cmd(Key::Home.code(), Some(nv_home), NV_SSS | NV_STS, 0),
    cmd(Key::Khome.code(), Some(nv_home), NV_SSS | NV_STS, 0),
    cmd(Key::SHome.code(), Some(nv_home), NV_SS, 0),
    cmd(
    ...
    cmd(Key::Del.code(), Some(nv_abbrev), 0, 0),
    cmd(
    ...
    cmd(Key::Undo.code(), Some(nv_kundo), 0, 0),
    cmd(Key::Help.code(), Some(nv_help), NV_NCW, 0),
    cmd(Key::F1.code(), Some(nv_help), NV_NCW, 0),
    cmd(
    ...
    cmd(Key::Select.code(), Some(nv_select), 0, 0),
    cmd(Key::PasteStart.code(), Some(nv_paste), NV_KEEPREG, 0),
    cmd(
