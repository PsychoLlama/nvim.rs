    ...
    unsafe {
        ...
        'done: {
            ...
            'free_arg_3: {
                ...
                let ret = nvim_open_tabpage(arg_1, arg_2, &raw mut arg_3, &raw mut err);
                nlua_push_handle(lstate, ret, PUSH);
                active_lstate.set(saved_lstate);
            }
            api_luarefs_free_keydict((&raw mut arg_3).cast(), tabpage_config_table.ptr().cast());
        }
...
pub unsafe extern "C-unwind" fn nlua_api_nvim_tabpage_del_var(lstate: *mut lua_State) -> c_int {
    unsafe {
        ...
        'done: {
            ...
            let saved_lstate = active_lstate.get();
            active_lstate.set(lstate);
            nvim_tabpage_del_var(arg_1, arg_2, &raw mut err);
            active_lstate.set(saved_lstate);
        }
        if finish(lstate, &raw mut arena, &raw mut err, err_param) {
            return lua_error(lstate);
        ...
        'done: {
            ...
            if !nlua_is_deferred_safe() {
                return luaL_error(
                    lstate,
                    (&raw const e_fast_api_disabled).cast(),
                    c"nvim_tabpage_get_number".as_ptr(),
                );
            }
            let arg_1 = nlua_pop_handle(lstate, &raw mut arena, &raw mut err);
            if err.type_0 != kErrorTypeNone {
            ...
            let saved_lstate = active_lstate.get();
            active_lstate.set(lstate);
            let ret = nvim_tabpage_get_number(arg_1, &raw mut err);
...
pub unsafe extern "C-unwind" fn nlua_api_nvim_tabpage_get_var(lstate: *mut lua_State) -> c_int {
    unsafe {
        ...
        'done: {
            ...
            let saved_lstate = active_lstate.get();
            active_lstate.set(lstate);
            let mut ret = nvim_tabpage_get_var(arg_1, arg_2, &raw mut arena, &raw mut err);
...
pub unsafe extern "C-unwind" fn nlua_api_nvim_tabpage_get_win(lstate: *mut lua_State) -> c_int {
    unsafe {
        ...
        'done: {
            ...
            let saved_lstate = active_lstate.get();
            active_lstate.set(lstate);
            let ret = nvim_tabpage_get_win(arg_1, &raw mut err);
        ...
        'done: {
            ...
            if !nlua_is_deferred_safe() {
                return luaL_error(
                    lstate,
                    (&raw const e_fast_api_disabled).cast(),
                    c"nvim_tabpage_is_valid".as_ptr(),
                );
            }
            let arg_1 = nlua_pop_handle(lstate, &raw mut arena, &raw mut err);
            if err.type_0 != kErrorTypeNone {
        ...
        'done: {
            ...
            if !nlua_is_deferred_safe() {
                return luaL_error(
                    lstate,
                    (&raw const e_fast_api_disabled).cast(),
                    c"nvim_tabpage_list_wins".as_ptr(),
                );
            }
            let arg_1 = nlua_pop_handle(lstate, &raw mut arena, &raw mut err);
            if err.type_0 != kErrorTypeNone {
            ...
            let saved_lstate = active_lstate.get();
            active_lstate.set(lstate);
            let ret = nvim_tabpage_list_wins(arg_1, &raw mut arena, &raw mut err);
    ...
    unsafe {
        ...
        'done: {
            ...
            'free_arg_3: {
                ...
                let saved_lstate = active_lstate.get();
                active_lstate.set(lstate);
                nvim_tabpage_set_var(arg_1, arg_2, arg_3, &raw mut err);
                active_lstate.set(saved_lstate);
            }
...
pub unsafe extern "C-unwind" fn nlua_api_nvim_tabpage_set_win(lstate: *mut lua_State) -> c_int {
    unsafe {
        ...
        'done: {
            ...
            let saved_lstate = active_lstate.get();
            active_lstate.set(lstate);
            nvim_tabpage_set_win(arg_1, arg_2, &raw mut err);
            active_lstate.set(saved_lstate);
        }
        if finish(lstate, &raw mut arena, &raw mut err, err_param) {
            return lua_error(lstate);
