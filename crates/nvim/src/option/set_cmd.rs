...
use crate::types::{
    CMD_index, CMD_setglobal, CMD_setlocal, FAIL, OK, OptIndex, OptInt, OptVal, OptValData,
...
use super::{
    FSK_KEEP_X_KEY, FSK_KEYCODE, FSK_SIMPLIFY, IOSIZE, NUL, OP_ADDING, OP_NONE, OP_PREPENDING,
