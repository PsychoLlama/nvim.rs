...
use crate::main::{
    ...
    emsg_silent, ex_no_reprint, exiting, exmode_active, firstbuf, global_busy, got_int,
    in_assert_fails, keep_msg, msg_col, msg_listdo_overwrite, msg_scroll, msg_scrolled,
    msg_scrolled_ign, msg_silent, need_check_timestamps, need_fileinfo, need_wait_return,
    no_check_timestamps, no_wait_return, p_ar, p_ccv, p_enc, p_fencs, p_ffs, p_fic, p_ur,
    p_verbose, readonlymode, recoverymode, redraw_cmdline, redraw_tabline, restart_edit, stdin_fd,
