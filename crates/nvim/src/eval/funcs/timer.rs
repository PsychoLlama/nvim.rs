...
/// forgetting it.
pub unsafe fn f_timer_pause(argvars: *mut TypVal, _unused: *mut TypVal, _fptr: EvalFuncData) {
...
/// `timer_stopall()`.
pub unsafe fn f_timer_stopall(_argvars: *mut TypVal, _unused: *mut TypVal, _fptr: EvalFuncData) {
