...
use crate::main::{
    Columns, Rows, curbuf, curwin, display_tick, e_invarg2, e_nogroup, e_notopen, got_int,
    include_default, include_link, include_none, msg_col, p_cpo, re_extmatch_in, re_extmatch_out,
    reg_do_extmatch,
};
