...
use crate::types::{
    Direction, IOSIZE, NUL, OK, OptVal, OptValData, exarg_T, hashitem_T, idx_T, langp_T, linenr_T,
    size_t, slang_T, wordcount_T,
};
...
use super::{
    MAXWLEN, OPT_LOCAL, WC_KEY_OFF, WF_ALLCAP, WF_BANNED, WF_CAPMASK, WF_FIXCAP, WF_KEEPCAP,
    WF_NEEDCOMP, WF_ONECAP, WF_RARE, WF_RAREPFX, WF_REGION, kOptValTypeBoolean,
};
