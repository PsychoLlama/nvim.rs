...
use crate::src::nvim::memory::{
    ARENA_EMPTY, arena_finish, arena_mem_free, xcalloc, xfree, xmalloc, xmemdupz, xrealloc,
    xstrdup, xstrlcpy,
};
...
use crate::src::nvim::options::{
    kOptInvalid, kOptRulerformat, kOptStatuscolumn, kOptStatusline, kOptTabline, kOptWinbar,
};
...
pub use crate::src::nvim::types::{
    ...
    BufUpdateCallbacks, Buffer, Callback, Callback_data as C2Rust_Unnamed_6, CallbackType,
    ...
    Map_uint64_t_ptr_t, MapHash, MarkTree, NS, Object, ObjectType, OptIndex, OptInt, OptVal,
    ...
    kObjectTypeArray, kObjectTypeBuffer, kObjectTypeDict, kObjectTypeInteger, kObjectTypeNil,
    kObjectTypeString, kObjectTypeTabpage, key_value_pair, lcs_chars_T, linenr_T, list_T,
    ...
    proftime_T, ptr_t, ptrdiff_t, qf_info_S, qf_info_T, queue, reg_extmatch_T, regmmatch_T,
    regprog, regprog_T, sattr_T, schar_T, scid_T, sctx_T, size_t, ssize_t, statuscol_T, stl_hlrec,
