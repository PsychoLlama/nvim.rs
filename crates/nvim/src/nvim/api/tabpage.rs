...
pub use crate::src::nvim::types::{
    ...
    KeyDict_tabpage_config, KeyValuePair, LuaRef, MTKey, MTNode, MTPos, Map_int64_t_int64_t,
    ...
    hashitem_T, hashtab_T, infoptr_T, int16_t, int32_t, int64_t, kObjectTypeNil, kObjectTypeWindow,
    ...
    scid_T, sctx_T, size_t, syn_state, syn_state_sst_union as C2Rust_Unnamed_4, syn_time_T,
