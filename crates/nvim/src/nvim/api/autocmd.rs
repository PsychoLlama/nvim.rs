...
use crate::src::nvim::types::{
    AlignTextPos, Arena, Array, ArrayBuilder, AutoCmd, AutoCmdVec, AutoPat, BoolVarValue, Buffer,
    CMD_index, Callback, Callback_data as C2Rust_Unnamed_5, Dict, Error, FloatRelative, Integer,
    KeyDict_clear_autocmds, KeyDict_create_augroup, KeyDict_create_autocmd, KeyDict_exec_autocmds,
    KeyDict_get_autocmds, LuaRef, Object, ScopeType, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_12, String_0, TryState, VarLockStatus, VarType,
    WinSplit, WinStyle, auto_event, buf_T, cmd_addr_T, event_T, exarg_T, except_T, except_type_T,
    int64_t, kObjectTypeArray, kObjectTypeBoolean, kObjectTypeBuffer, kObjectTypeDict,
