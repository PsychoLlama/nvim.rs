...
pub use crate::src::nvim::types::{
    ...
    Float, FloatAnchor, FloatRelative, GridView, Integer, Intersection, KeyDict_clear_autocmds,
    ...
    pos_save_T, proftime_T, ptr_t, qf_info_S, qf_info_T, queue, reg_extmatch_T, regmmatch_T,
