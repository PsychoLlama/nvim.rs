...
pub use crate::src::nvim::types::{
    ...
    DecorPriority, DecorPriorityInternal, DecorProvider, DecorProvider_state as C2Rust_Unnamed_20,
    DecorRange, DecorRange_data as C2Rust_Unnamed_24, DecorRange_data_ui as C2Rust_Unnamed_25,
    DecorRangeKind, DecorRangeSlot, DecorSignHighlight, DecorState,
    DecorState_ranges_i as C2Rust_Unnamed_22, DecorState_slots as C2Rust_Unnamed_23, DecorVirtText,
    DecorVirtText_data as C2Rust_Unnamed_2, Dict, Error, ErrorType, ExtmarkInfoArray, ExtmarkMove,
    ExtmarkSavePos, ExtmarkSplice, ExtmarkType, ExtmarkUndoObject, FileID, Float, FloatAnchor,
    FloatRelative, GridView, HLGroupID, Integer, Intersection, KeyDict_get_extmark,
    KeyDict_get_extmarks, KeyDict_ns_opts, KeyDict_set_decoration_provider, KeyDict_set_extmark,
    KeySetLink, KeyValuePair, LuaRef, MHPutStatus, MTKey, MTNode, MTPair, MTPos, Map_String_int,
    Map_int64_t_int64_t, Map_int64_t_ptr_t, Map_uint32_t_uint32_t, Map_uint64_t_ptr_t, MapHash,
    MarkTree, MarkTreeIter, MarkTreeIter_s as C2Rust_Unnamed_21, NS, Object, ObjectType, OptInt,
    OptionalKeys, QUEUE, ScopeDictDictItem, ScopeType, ScreenGrid, Set_String, Set_int64_t,
    Set_ptr_t, Set_uint32_t, Set_uint64_t, SpecialVarValue, StlClickDefinition,
    ...
    reg_extmatch_T, regmmatch_T, regprog, regprog_T, sattr_T, schar_T, scid_T, sctx_T, sign_T,
