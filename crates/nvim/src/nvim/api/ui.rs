...
pub use crate::src::nvim::types::{
    ...
    ptr_t, queue, rstream, sattr_T, schar_T, scid_T, sctx_T, size_t, ssize_t, stream,
    stream_close_cb, stream_read_cb, stream_uv as C2Rust_Unnamed_12, stream_write_cb, terminal,
    typval_T, typval_vval_union, ufunc_S, ufunc_T, uid_t, uint8_t, uint16_t, uint32_t, uint64_t,
