...
pub use crate::src::nvim::types::{
    ...
    KeyDict_win_text_height, KeyValuePair, LuaRef, LuaRetMode, MTKey, MTNode, MTPos,
    Map_int64_t_int64_t, Map_int64_t_ptr_t, Map_uint32_t_uint32_t, Map_uint64_t_ptr_t, MapHash,
    MarkTree, NS, Object, ObjectType, OptInt, OptionalKeys, QUEUE, ScopeDictDictItem, ScopeType,
    ...
    bufstate_T, chunksize_T, colnr_T, dict_T, dictvar_S, diff_T, diffblock_S, disptick_T, except_T,
    ...
    hashitem_T, hashtab_T, infoptr_T, int16_t, int32_t, int64_t, kObjectTypeInteger,
    kObjectTypeNil, key_value_pair, lcs_chars_T, linenr_T, list_T, listitem_S, listitem_T,
    ...
    object, object_data as C2Rust_Unnamed, partial_S, partial_T, pos_T, pos_save_T, proftime_T,
    ptr_t, qf_info_S, qf_info_T, queue, reg_extmatch_T, regmmatch_T, regprog, regprog_T, sattr_T,
    schar_T, scid_T, sctx_T, size_t, switchwin_T, syn_state,
