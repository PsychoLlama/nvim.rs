...
pub use crate::src::nvim::types::{
    ...
    CallbackType, ChangedtickDictItem, CmdParseInfo, CmdParseInfo_magic as C2Rust_Unnamed_13,
    ...
    u_header_uh_prev as C2Rust_Unnamed_9, ucmd_T, ufunc_S, ufunc_T, uint8_t, uint16_t, uint32_t,
    uint64_t, undo_object, varnumber_T, vim_exception, virt_line, visualinfo_T, win_T, window_S,
    wininfo_S, winopt_T, wline_T, xfmark_T, xp_prefix_T,
};
