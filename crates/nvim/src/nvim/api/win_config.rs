...
use crate::src::nvim::types::{
    ...
    ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12, String_0, TryState,
    VarLockStatus, VarType, VirtText, VirtTextChunk, WinConfig, WinSplit, WinStyle, Window,
    auto_event, buf_T, bufref_T, colnr_T, except_T, except_type_T, frame_T, int64_t,
