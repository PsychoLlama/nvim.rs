...
pub use crate::src::nvim::types::{
    ...
    KeyDict_win_config, KeyValuePair, LuaRef, MTKey, MTNode, MTPos, Map_int64_t_int64_t,
    ...
    blocknr_T, buf_T, bufref_T, bufstate_T, chunksize_T, cmdidx_T, colnr_T, dict_T, dictvar_S,
    diff_T, diffblock_S, disptick_T, event_T, except_T, except_type_T, extmark_undo_vec_t,
    ...
    msglist_T, mtnode_inner_s, mtnode_s, object, object_data as C2Rust_Unnamed, partial_S,
