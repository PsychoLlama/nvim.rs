...
pub use crate::src::nvim::types::{
    ...
    DecorSignHighlight, DecorVirtText, DecorVirtText_data as C2Rust_Unnamed_2, Direction, Error,
    ErrorType, EvalFuncData, ExtmarkMove, ExtmarkSavePos, ExtmarkSplice, ExtmarkUndoObject, FileID,
    FloatAnchor, FloatRelative, GridView, Integer, Intersection, LineGetter, ListLenSpecials,
    LuaRef, MTKey, MTNode, MTPair, MTPos, Map_String_int, Map_cstr_t_ptr_t, Map_int64_t_int64_t,
    Map_int64_t_ptr_t, Map_uint32_t_uint32_t, Map_uint64_t_ptr_t, MapHash, MarkTree, MarkTreeIter,
    MarkTreeIter_s as C2Rust_Unnamed_16, MetaIndex, MsgpackRpcRequestHandler, NS, OptInt, QUEUE,
    ...
    WinSplit, WinStyle, Window, alist_T, bcount_t, bhdr_T, blob_T, blobvar_S, blocknr_T, buf_T,
