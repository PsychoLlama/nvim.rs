...
use crate::src::nvim::types::{
    AdditionalData, AlignTextPos, BoolVarValue, CMD_index, Callback,
    Callback_data as C2Rust_Unnamed_5, ExtmarkOp, FloatRelative, OptInt, OptVal, OptValData,
    OptValType, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_13,
    String_0, SubReplacementString, Timestamp, TriState, UndoObjectType, VarLockStatus, VarType,
    VimVarIndex, WinSplit, WinStyle, auto_event, bcount_t, bfa_values, bln_values, buf_T, bufref_T,
    cmd_addr_T, colnr_T, dobuf_action_values, exarg_T, float_T, fmark_T, getf_retvalues, handle_T,
    int32_t, int64_t, linenr_T, list_T, listitem_T, lpos_T, magic_T, pos_T, proftime_T, ptrdiff_t,
