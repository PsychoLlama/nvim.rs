...
use crate::src::nvim::types::{
    AlignTextPos, Arena, Array, AutoCmd, AutoCmdVec, AutoPat, AutoPatCmd, AutoPatCmd_S,
    BoolVarValue, Buffer, CMD_index, Callback, Callback_data as C2Rust_Unnamed_5, Dict, Direction,
    Error, Event, FloatRelative, Integer, KeyValuePair, LuaRetMode, Map_String_int, Map_int_String,
    Map_int_ptr_t, MapHash, Object, OptInt, OptVal, OptValData, OptValType, ProcType, ScopeType,
    Set_String, Set_int, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12, String_0,
    Timestamp, TriState, VarLockStatus, VarType, VimVarIndex, WinSplit, WinStyle, aco_save_T,
    aucmdwin_T, auto_event, buf_T, buffblock, buffblock_T, buffheader_T, bufref_T, cmd_addr_T,
    dict_T, estack_T, etype_T, event_T, exarg_T, except_type_T, expand_T, funccal_entry_T,
    handle_T, hashitem_T, hashtab_T, int64_t, kObjectTypeBoolean, kObjectTypeDict,
    kObjectTypeInteger, kObjectTypeNil, kObjectTypeString, key_value_pair, linenr_T, object,
    ...
    uv_handle_type, uv_req_type, varnumber_T, win_T, xp_prefix_T,
};
