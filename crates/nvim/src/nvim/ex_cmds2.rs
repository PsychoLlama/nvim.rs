...
pub use crate::src::nvim::types::{
    ...
    GridView, Intersection, LineGetter, LuaRef, MTKey, MTNode, MTPos, Map_int64_t_int64_t,
    ...
    VirtTextPos, WinConfig, WinInfo, WinSplit, WinStyle, Window, aco_save_T, aentry_T, alist_T,
