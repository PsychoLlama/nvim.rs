...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, Direction, FloatRelative, ScopeType, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_12, VarLockStatus, VarType, VimVarIndex, WinSplit,
    WinStyle, buf_T, evalarg_T, expand_T, int64_t, pos_T, ptrdiff_t, sctx_T, size_t, uint8_t,
    xp_prefix_T,
};
unsafe extern "C" {
