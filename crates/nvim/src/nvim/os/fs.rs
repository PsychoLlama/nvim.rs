...
use crate::src::nvim::main::{g_stats, p_verbose, stdin_fd};
...
use crate::src::nvim::os::libc::{
    __errno_location, abort, dup, fcntl, fdopen, read, readv, strerror, write,
};
use crate::src::nvim::path::{append_path, gettail_dir, save_abs_path};
