...
use crate::src::nvim::types::{
    ...
    SpecialVarValue, Stream, String_0, StringBuilder, VV_SHELL_ERROR, VarLockStatus, VarType,
    WBuffer, colnr_T, int64_t, intptr_t, linenr_T, proftime_T, size_t, stream_read_cb, uint8_t,
