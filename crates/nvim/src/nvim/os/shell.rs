...
use crate::src::nvim::os::libc::{fclose, fopen, fread, fseek, ftell, gettext, strcmp, strcpy};
...
use crate::src::nvim::strings::{vim_snprintf, vim_strnsave_unquoted, vim_strsave_escaped_ext};
