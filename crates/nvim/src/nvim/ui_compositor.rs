...
pub use crate::src::nvim::types::{
    ...
    GridView, Integer, Intersection, LineFlags, LuaRef, MTKey, MTNode, MTPos, Map_int64_t_int64_t,
    Map_int64_t_ptr_t, Map_uint32_t_uint32_t, Map_uint64_t_ptr_t, MapHash, MarkTree, OptInt,
    PackerBuffer, PackerBufferFlush, QUEUE, RemoteUI, ScopeDictDictItem, ScopeType, ScreenGrid,
