...
//! a [`Cursor`](crate::src::nvim::marktree::cursor::Cursor). The iterator is
...
use crate::src::nvim::marktree::cursor::tree_of;
use crate::src::nvim::marktree::key::{MT_INVALID_KEY, mt_decor, mt_decor_any, mt_end, mt_invalid};
