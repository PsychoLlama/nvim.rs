...
pub use crate::src::nvim::types::{
    ...
    exarg_T, expand_T, extmark_undo_vec_t, fcs_chars_T, file_buffer,
    ...
    getf_retvalues, getf_values, handle_T, hash_T, hashitem_T, hashtab_T, ht_stack_S, ht_stack_T,
    iconv_t, infoptr_T, int16_t, int32_t, int64_t, lcs_chars_T, linenr_T, list_T, list_stack_S,
    list_stack_T, listitem_S, listitem_T, listvar_S, listwatch_S, listwatch_T, llpos_T, lpos_T,
    mapblock, mapblock_T, match_T, matchitem, matchitem_T, memfile_T, memline_T, mfdirty_T,
    mtnode_inner_s, mtnode_s, off_T, off_t, oparg_T, optmagic_T, optset_T, partial_S, partial_T,
