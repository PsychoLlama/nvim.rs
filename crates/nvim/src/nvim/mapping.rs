...
use crate::src::nvim::types::{
    AlignTextPos, Arena, Array, ArrayBuilder, BoolVarValue, Buffer, CMD_index, Dict, Direction,
    Error, EvalFuncData, FILE, FloatRelative, Integer, KeyDict_keymap, ListLenSpecials, LuaRef,
    LuaRetMode, Object, OptInt, RemapValues, ScopeType, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_12, String_0, TriState, VarLockStatus, VarType,
    WinSplit, WinStyle, auto_event, buf_T, cmd_addr_T, cmdidx_T, colnr_T, dict_T, dictitem_T,
    estack_T, etype_T, exarg_T, except_type_T, expand_T, fuzmatch_str_T, garray_T, kObjectTypeDict,
    ...
    uint64_t, varnumber_T, xp_prefix_T,
};
unsafe extern "C" {
