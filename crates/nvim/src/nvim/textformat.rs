...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, FloatRelative, MotionType, ScopeType, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_12, VarLockStatus, VarType, VimVarIndex, WinSplit,
    WinStyle, colnr_T, linenr_T, oparg_T, pos_T, ptrdiff_t, sctx_T, size_t, uint8_t, varnumber_T,
    win_T,
};
