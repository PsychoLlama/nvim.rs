...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, CMD_index, Direction, EvalFuncData, FloatRelative, ListLenSpecials,
    RemapValues, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_11,
    String_0, TriState, VarLockStatus, VarType, WinSplit, WinStyle, auto_event, buffblock,
    buffblock_T, buffheader_T, cmd_addr_T, colnr_T, dict_T, exarg_T, expand_T, garray_T, linenr_T,
    list_T, pos_T, ptrdiff_t, save_state_T, scid_T, size_t, ssize_t, tasave_T, typebuf_T, typval_T,
    uint8_t, varnumber_T, vimmenu_T, xp_prefix_T,
};
