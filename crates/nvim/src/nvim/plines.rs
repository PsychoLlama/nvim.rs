...
pub use crate::src::nvim::types::{
    ...
    CharsizeArg, DecorExt, DecorHighlightInline, DecorInline, DecorInlineData, DecorPriority,
    ...
    MarkTreeIter_s as C2Rust_Unnamed_14, MetaFilter, MetaIndex, OptInt, QUEUE, ScopeDictDictItem,
