...
use crate::src::nvim::os::libc::{strcmp, strstr};
use crate::src::nvim::os::time::os_time;
use crate::src::nvim::spell::spell_reload;
use crate::src::nvim::strings::vim_strchr;
use crate::src::nvim::types::{
    AdditionalData, OptInt, OptVal, OptValData, String_0, buf_T, colnr_T, fmark_T, fmarkv_T,
