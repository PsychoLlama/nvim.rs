...
use crate::src::nvim::main::{State, VIsual, VIsual_active, VIsual_mode, mod_mask};
...
pub fn extend_visual_block(mut win: Win, mut start_visual: pos_T, mut end_visual: pos_T) {
