...
pub use crate::src::nvim::types::{
    ...
    __socklen_t, Loop, LuaRef, MultiQueue, Proc, ProcType, QUEUE, RStream, ScopeType,
    SocketWatcher, Stream, TriState, VarLockStatus, VimVarIndex, XDGVarType, addrinfo, dict_T,
    dictvar_S, garray_T, hash_T, hashitem_T, hashtab_T, int64_t, internal_proc_cb, loop_0,
    multiqueue, proc, proc_exit_cb, proc_state_cb, pthread_mutex_t, pthread_rwlock_t, ptrdiff_t,
    queue, rstream, sa_family_t, size_t, sockaddr, socket_cb, socket_close_cb, socket_watcher,
    ...
    stream_read_cb, stream_uv as C2Rust_Unnamed_12, stream_write_cb, uint8_t, uint32_t, uint64_t,
