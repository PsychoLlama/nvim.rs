...
pub use crate::src::nvim::types::{
    ...
    Intersection, KeyValuePair, ListLenSpecials, LuaRef, MTKey, MTNode, MTPos, Map_int64_t_int64_t,
    ...
    chunksize_T, colnr_T, dict_T, dictitem_T, dictvar_S, disptick_T, extmark_undo_vec_t,
