...
pub use crate::src::nvim::types::{
    ...
    int8_t, int64_t, internal_proc_cb, key_value_pair, loop_0, multiqueue, object,
    object_data as C2Rust_Unnamed, proc, proc_exit_cb, proc_state_cb, pthread_mutex_t,
    pthread_rwlock_t, ptr_t, queue, rstream, size_t, ssize_t, stream, stream_close_cb,
    stream_read_cb, stream_uv as C2Rust_Unnamed_10, stream_write_cb, uint8_t, uint32_t, uint64_t,
