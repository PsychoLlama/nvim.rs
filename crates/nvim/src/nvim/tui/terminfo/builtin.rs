...
use crate::src::nvim::tui::terminfo::caps::{MAX_FUNCTION_KEY, TerminfoDef, kTermCount};
use crate::src::nvim::tui::terminfo::is_term_family;
use crate::src::nvim::types::TerminfoEntry;
...
mod tests {
    use super::*;
    use crate::src::nvim::tui::terminfo::caps::{KEYS, STRING_CAPS, key_slot};
