...
//!
//! [`TerminfoEntry`](crate::src::nvim::types::TerminfoEntry) stores its
...
mod unibi_cap {
    ...
    pub const CARRIAGE_RETURN: super::UnibiString = 88;
    pub const CHANGE_SCROLL_REGION: super::UnibiString = 89;
    pub const CLEAR_SCREEN: super::UnibiString = 91;
    pub const CLR_EOL: super::UnibiString = 92;
    pub const CLR_EOS: super::UnibiString = 93;
    pub const CURSOR_ADDRESS: super::UnibiString = 96;
    pub const CURSOR_DOWN: super::UnibiString = 97;
    pub const CURSOR_INVISIBLE: super::UnibiString = 99;
    pub const CURSOR_LEFT: super::UnibiString = 100;
    pub const CURSOR_HOME: super::UnibiString = 98;
    pub const CURSOR_NORMAL: super::UnibiString = 102;
    pub const CURSOR_UP: super::UnibiString = 105;
    pub const CURSOR_RIGHT: super::UnibiString = 103;
    pub const DELETE_LINE: super::UnibiString = 108;
    pub const ENTER_BLINK_MODE: super::UnibiString = 112;
    pub const ENTER_BOLD_MODE: super::UnibiString = 113;
    pub const ENTER_CA_MODE: super::UnibiString = 114;
    pub const ENTER_DIM_MODE: super::UnibiString = 116;
    pub const ENTER_ITALICS_MODE: super::UnibiString = 397;
    pub const ENTER_REVERSE_MODE: super::UnibiString = 120;
    pub const ENTER_SECURE_MODE: super::UnibiString = 118;
    pub const ENTER_STANDOUT_MODE: super::UnibiString = 121;
    pub const ENTER_UNDERLINE_MODE: super::UnibiString = 122;
    pub const ERASE_CHARS: super::UnibiString = 123;
    pub const EXIT_ATTRIBUTE_MODE: super::UnibiString = 125;
    pub const EXIT_CA_MODE: super::UnibiString = 126;
    pub const FROM_STATUS_LINE: super::UnibiString = 133;
    pub const INSERT_LINE: super::UnibiString = 139;
    pub const KEYPAD_LOCAL: super::UnibiString = 174;
    pub const KEYPAD_XMIT: super::UnibiString = 175;
    pub const PARM_DELETE_LINE: super::UnibiString = 192;
    pub const PARM_DOWN_CURSOR: super::UnibiString = 193;
    pub const PARM_INSERT_LINE: super::UnibiString = 196;
    pub const PARM_LEFT_CURSOR: super::UnibiString = 197;
    pub const PARM_RIGHT_CURSOR: super::UnibiString = 198;
    pub const PARM_UP_CURSOR: super::UnibiString = 200;
    pub const SET_A_BACKGROUND: super::UnibiString = 446;
    pub const SET_A_FOREGROUND: super::UnibiString = 445;
    pub const SET_ATTRIBUTES: super::UnibiString = 217;
    pub const SET_LR_MARGIN: super::UnibiString = 454;
    pub const TO_STATUS_LINE: super::UnibiString = 221;

    pub const KEY_BACKSPACE: super::UnibiString = 141;
    pub const KEY_BEG: super::UnibiString = 244;
    pub const KEY_SBEG: super::UnibiString = 272;
    pub const KEY_BTAB: super::UnibiString = 234;
    pub const KEY_CLEAR: super::UnibiString = 143;
    pub const KEY_DC: super::UnibiString = 145;
    pub const KEY_SDC: super::UnibiString = 277;
    pub const KEY_END: super::UnibiString = 250;
    pub const KEY_SEND: super::UnibiString = 280;
    pub const KEY_FIND: super::UnibiString = 253;
    pub const KEY_SFIND: super::UnibiString = 283;
    pub const KEY_HOME: super::UnibiString = 162;
    pub const KEY_SHOME: super::UnibiString = 285;
    pub const KEY_IC: super::UnibiString = 163;
    pub const KEY_SIC: super::UnibiString = 286;
    pub const KEY_NPAGE: super::UnibiString = 167;
    pub const KEY_PPAGE: super::UnibiString = 168;
    pub const KEY_SELECT: super::UnibiString = 279;
    pub const KEY_SUSPEND: super::UnibiString = 270;
    pub const KEY_SSUSPEND: super::UnibiString = 299;
    pub const KEY_UNDO: super::UnibiString = 271;
    pub const KEY_SUNDO: super::UnibiString = 300;
    pub const KEY_LEFT: super::UnibiString = 165;
    pub const KEY_SLEFT: super::UnibiString = 287;
    pub const KEY_RIGHT: super::UnibiString = 169;
    pub const KEY_SRIGHT: super::UnibiString = 296;

    pub const KEY_F1: super::UnibiString = 152;
    pub const KEY_F2: super::UnibiString = 154;
    pub const KEY_F3: super::UnibiString = 155;
    pub const KEY_F4: super::UnibiString = 156;
    pub const KEY_F5: super::UnibiString = 157;
    pub const KEY_F6: super::UnibiString = 158;
    pub const KEY_F7: super::UnibiString = 159;
    pub const KEY_F8: super::UnibiString = 160;
    pub const KEY_F9: super::UnibiString = 161;
    pub const KEY_F10: super::UnibiString = 153;
    pub const KEY_F11: super::UnibiString = 302;
    pub const KEY_F12: super::UnibiString = 303;
    pub const KEY_F13: super::UnibiString = 304;
    pub const KEY_F14: super::UnibiString = 305;
    pub const KEY_F15: super::UnibiString = 306;
    pub const KEY_F16: super::UnibiString = 307;
    pub const KEY_F17: super::UnibiString = 308;
    pub const KEY_F18: super::UnibiString = 309;
    pub const KEY_F19: super::UnibiString = 310;
    pub const KEY_F20: super::UnibiString = 311;
    pub const KEY_F21: super::UnibiString = 312;
    pub const KEY_F22: super::UnibiString = 313;
    pub const KEY_F23: super::UnibiString = 314;
    pub const KEY_F24: super::UnibiString = 315;
    pub const KEY_F25: super::UnibiString = 316;
    pub const KEY_F26: super::UnibiString = 317;
    pub const KEY_F27: super::UnibiString = 318;
    pub const KEY_F28: super::UnibiString = 319;
    pub const KEY_F29: super::UnibiString = 320;
    pub const KEY_F30: super::UnibiString = 321;
    pub const KEY_F31: super::UnibiString = 322;
    pub const KEY_F32: super::UnibiString = 323;
    pub const KEY_F33: super::UnibiString = 324;
    pub const KEY_F34: super::UnibiString = 325;
    pub const KEY_F35: super::UnibiString = 326;
    pub const KEY_F36: super::UnibiString = 327;
    pub const KEY_F37: super::UnibiString = 328;
    pub const KEY_F38: super::UnibiString = 329;
    pub const KEY_F39: super::UnibiString = 330;
    pub const KEY_F40: super::UnibiString = 331;
    pub const KEY_F41: super::UnibiString = 332;
    pub const KEY_F42: super::UnibiString = 333;
    pub const KEY_F43: super::UnibiString = 334;
    pub const KEY_F44: super::UnibiString = 335;
    pub const KEY_F45: super::UnibiString = 336;
    pub const KEY_F46: super::UnibiString = 337;
    pub const KEY_F47: super::UnibiString = 338;
    pub const KEY_F48: super::UnibiString = 339;
    pub const KEY_F49: super::UnibiString = 340;
    pub const KEY_F50: super::UnibiString = 341;
    pub const KEY_F51: super::UnibiString = 342;
    pub const KEY_F52: super::UnibiString = 343;
    pub const KEY_F53: super::UnibiString = 344;
    pub const KEY_F54: super::UnibiString = 345;
    pub const KEY_F55: super::UnibiString = 346;
    pub const KEY_F56: super::UnibiString = 347;
    pub const KEY_F57: super::UnibiString = 348;
    pub const KEY_F58: super::UnibiString = 349;
    pub const KEY_F59: super::UnibiString = 350;
    pub const KEY_F60: super::UnibiString = 351;
    pub const KEY_F61: super::UnibiString = 352;
    pub const KEY_F62: super::UnibiString = 353;
    pub const KEY_F63: super::UnibiString = 354;
}
