...
use crate::src::nvim::charset::{getwhitecols, skipwhite};
...
use crate::src::nvim::main::{bot_top_msg, curwin, decor_state, got_int, p_ws, top_bot_msg};
use crate::src::nvim::memline::{ml_get_buf, ml_get_buf_len};
use crate::src::nvim::memory::{xfree, xmalloc, xstrlcpy};
use crate::src::nvim::message::give_warning;
...
use super::{
    HLF_COUNT, HLF_SPB, HLF_SPR, MAXCOL, MAXWLEN, NUL, SHM_SEARCH, SMT_ALL, SMT_BAD, SMT_RARE,
    kFalse, kTrue,
};
