...
use crate::src::nvim::marktree::key::{mt_end, mt_paired, mt_start, unrelative};
use crate::src::nvim::marktree::node::Node;
use crate::src::nvim::memory::xmemdupz;
use crate::src::nvim::types::{MTPos, MarkTree, String_0, uint64_t};
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mt_inspect(b: &mut MarkTree, keys: bool, dot: bool) -> String_0 {
