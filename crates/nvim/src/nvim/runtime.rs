...
use crate::src::nvim::types::{
    __pthread_internal_list, __pthread_list_t, __pthread_mutex_s, AlignTextPos, Arena, Array,
    BoolVarValue, CMD_index, Dict, Direction, DoInRuntimepathCB, Error, EvalFuncData, FILE,
    FloatRelative, Integer, LineGetter, LuaRetMode, MHPutStatus, Map_String_int, MapHash, Object,
    OptInt, OptVal, OptValData, OptValType, ScopeType, Set_String, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_12, String_0, TriState, VarLockStatus, VarType,
    WinSplit, WinStyle, XDGVarType, auto_event, buf_T, cmd_addr_T, colnr_T, dict_T, dictitem_T,
    estack_T, estack_arg_T, etype_T, exarg_T, except_type_T, expand_T, funccal_entry_T, garray_T,
    handle_T, hashitem_T, hashtab_T, int64_t, kObjectTypeBoolean, kObjectTypeDict,
    kObjectTypeInteger, kObjectTypeNil, kObjectTypeString, key_value_pair, linenr_T, list_T,
    object, object_data as C2Rust_Unnamed, optset_T, proftime_T, pthread_mutex_t, ptrdiff_t,
    regmatch_T, regprog_T, scid_T, scriptitem_T, sctx_T, size_t, ssize_t, typval_T,
    typval_vval_union, ufunc_T, uint8_t, uint32_t, uv_mutex_t, varnumber_T, vimconv_T, win_T,
    xp_prefix_T,
};
