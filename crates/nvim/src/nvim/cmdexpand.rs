...
use crate::src::nvim::types::{
    AlignTextPos, Arena, Array, BoolVarValue, CMD_index, CmdRedraw, CmdlineInfo,
    CompleteListItemGetter, Direction, Error, EvalFuncData, FloatRelative, LuaRetMode, Object,
    OptInt, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12, String_0,
    VarLockStatus, VarType, WinSplit, WinStyle, buf_T, cmd_addr_T, cmdidx_T, colnr_T, cstack_T,
    dict_T, exarg_T, expand_T, fuzmatch_str_T, garray_T, hash_T, hashitem_T, hashtab_T, hlf_T,
    kObjectTypeArray, kObjectTypeNil, kObjectTypeString, linenr_T, list_T, listitem_T, object,
