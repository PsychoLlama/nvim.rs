...
pub use crate::src::nvim::types::{
    ...
    partial_S, partial_T, pos_T, pos_save_T, proftime_T, ptr_t, ptrdiff_t, pumitem_T, qf_info_S,
    qf_info_T, queue, reg_extmatch_T, regmatch_T, regmmatch_T, regprog, regprog_T, sattr_T,
    schar_T, scid_T, scriptitem_T, scriptvar_T, sctx_T, searchit_arg_T, size_t, ssize_t, syn_state,
