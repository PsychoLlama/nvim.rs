...
pub use crate::src::nvim::types::{
    ...
    CmdlineColorChunk, CmdlineColors, CmdlineInfo, ColoredCmdline, CompleteListItemGetter,
    ...
    KeyValuePair, LineGetter, LuaRef, LuaRetMode, MTKey, MTNode, MTPos, Map_int64_t_int64_t,
    Map_int64_t_ptr_t, Map_uint32_t_uint32_t, Map_uint64_t_ptr_t, MapHash, MarkTree,
    MsgpackRpcRequestHandler, NS, Object, ObjectType, OptInt, QUEUE, ScopeDictDictItem, ScopeType,
    ...
    kObjectTypeArray, kObjectTypeNil, kObjectTypeString, key_value_pair, lcs_chars_T, linenr_T,
    ...
    mtnode_s, object, object_data as C2Rust_Unnamed, partial_S, partial_T, pos_T, pos_save_T,
    proftime_T, ptr_t, ptrdiff_t, pumitem_T, qf_info_S, qf_info_T, queue, reg_extmatch_T,
    regmatch_T, regmmatch_T, regprog, regprog_T, sattr_T, schar_T, scid_T, scriptitem_T,
    scriptvar_T, sctx_T, searchit_arg_T, size_t, ssize_t, syn_state,
        ...
        if !selstart.is_null() && highlight as ::core::ffi::c_int != 0 {
            *selend = NUL as ::core::ffi::c_char;
            grid_line_puts(
                ...
                selstart,
                -1 as ::core::ffi::c_int,
                *(*hl_attr_active.ptr()).offset(HLF_WM as ::core::ffi::c_int as isize),
            );
        }
    ...
    's_685: {
        match cmdidx as ::core::ffi::c_int {
            ...
            451 | 431 | 335 | 262 | 489 | 437 | 343 | 474 | 436 | 338 => {
                if wop_flags.get() & kOptWopFlagTagfile as ::core::ffi::c_int as ::core::ffi::c_uint
                    != 0
                {
...
unsafe extern "C" fn copy_substring_from_pos(
    ...
    let mut exacttext: bool =
        wop_flags.get() & kOptWopFlagExacttext as ::core::ffi::c_int as ::core::ffi::c_uint != 0;
    ...
    *numMatches = 0 as ::core::ffi::c_int;
    ...
    '_cleanup: {
        loop {
            ...
            if char_avail() as ::core::ffi::c_int != 0 || got_int.get() as ::core::ffi::c_int != 0 {
                if got_int.get() {
                    vpeekc();
                    got_int.set(false_0 != 0);
                }
