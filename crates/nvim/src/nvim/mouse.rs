...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, CharsizeArg, CharsizeKind, Direction, EvalFuncData, FloatRelative,
    MotionType, OptInt, ScopeType, ScreenGrid, SpecialVarValue, StlClickDefinition,
    StlClickDefinition_type_0 as C2Rust_Unnamed_12, StrCharInfo, VarLockStatus, VarType, WinSplit,
    WinStyle, cmdarg_T, colnr_T, dict_T, frame_T, handle_T, key_extra, linenr_T, oparg_T, pos_T,
    size_t, tabpage_T, typval_T, typval_vval_union, uint8_t, varnumber_T, win_T, yankreg_T,
};
