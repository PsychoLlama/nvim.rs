...
pub use crate::src::nvim::types::{
    ...
    StlClickDefinition, StlClickDefinition_type_0 as C2Rust_Unnamed_11, Terminal, Timestamp,
    ...
    lua_CFunction, lua_Integer, lua_State, luaL_Reg, mapblock, mapblock_T, match_T, matchitem,
