...
pub use crate::src::nvim::types::{
    ...
    handle_T, hash_T, hashitem_T, hashtab_T, int32_t, int64_t, kObjectTypeArray,
    ...
    lua_Integer, lua_Number, lua_State, nlua_ref_state_t, object, object_data as C2Rust_Unnamed,
