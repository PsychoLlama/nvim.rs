...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, Callback, Callback_data as C2Rust_Unnamed_5, CharsizeArg,
    CharsizeKind, ExtmarkOp, FloatRelative, MotionType, OptInt, ScopeType, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_13, StrCharInfo, TriState, UndoObjectType,
    VarLockStatus, VarType, WinSplit, WinStyle, bcount_t, block_def, buf_T, cmdarg_T, colnr_T,
    dict_T, ht_stack_T, int32_t, int64_t, key_extra, linenr_T, list_stack_T, oparg_T, optset_T,
    pos_T, size_t, ssize_t, typval_T, typval_vval_union, uint8_t, uvarnumber_T, varnumber_T,
    yankreg_T,
};
