...
use super::*;
use crate::src::nvim::drawscreen::{UPD_NOT_VALID, comp_col, status_redraw_all};
...
use crate::src::nvim::message::msg_clr_eos_force;
...
use crate::src::nvim::types::{Integer, OptInt, frame_T, qf_info_T, win_T};
...
fn init(newp: Win, oldp: Win, flags: c_int) {
    ...
    unsafe { (*newp.w_alist).al_refcount += 1 };
