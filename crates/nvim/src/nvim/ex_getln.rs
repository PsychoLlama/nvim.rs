...
use crate::src::nvim::types::{
    AlignTextPos, Arena, Array, BoolVarValue, Boolean, CMD_index, Callback,
    Callback_data as C2Rust_Unnamed_5, CmdParseInfo, CmdParseInfo_magic as C2Rust_Unnamed_21,
    CmdRedraw, CmdlineColorChunk, CmdlineColors, CmdlineInfo, ColoredCmdline, Direction, Error,
    EvalFuncData, ExprAST, ExprASTNodeType, ExprAssignmentType, ExprCaseCompareStrategy,
    ExprComparisonType, ExprOptScope, ExprParserFlags, ExprVarScope, FloatRelative, HistoryType,
    Integer, MHPutStatus, MapHash, MotionType, Object, OptInt, OptVal, OptValData, OptValType,
    ParserHighlight, ParserHighlightChunk, ParserLine, ParserPosition, ParserState,
    ParserStateItem_data_expr_type_0 as C2Rust_Unnamed_33,
    ParserStateItem_type_0 as C2Rust_Unnamed_34, RemapValues, ScopeType, Set_ptr_t,
    SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_13, String_0, TriState, TryState,
    UndoObjectType, VarLockStatus, VarType, VimState, WinSplit, WinStyle, aco_save_T, auto_event,
    buf_T, bufref_T, cmd_addr_T, cmdmod_T, colnr_T, cstack_T, dict_T, dictitem_T, disptick_T,
    dobuf_action_values, dobuf_start_values, event_T, exarg, exarg_T, except_T, except_type_T,
    expand_T, garray_T, handle_T, hashitem_T, hashtab_T, int64_t, kObjectTypeArray,
    kObjectTypeInteger, kObjectTypeString, key_extra, linenr_T, list_T, listitem_T, magic_T,
    msglist_T, object, object_data as C2Rust_Unnamed, oparg_T, optmagic_T, optset_T, pos_T,
    proftime_T, ptr_t, ptrdiff_t, regmatch_T, regprog_T, save_v_event_T, sctx_T, searchit_arg_T,
    size_t, state_check_callback, state_execute_callback, tabpage_T, time_t, typval_T,
