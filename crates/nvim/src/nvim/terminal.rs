...
use crate::src::nvim::main::{State, buffer_handles, exiting};
...
use crate::src::nvim::winlayer::{Buf, Win, tab_windows, windows};
...
/// access, on [`winlayer`](crate::src::nvim::winlayer)'s pattern.
///
