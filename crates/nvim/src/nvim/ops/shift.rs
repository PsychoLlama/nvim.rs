...
unsafe fn get_new_sw_indent(left: bool, round: bool, amount: int64_t, sw_val: int64_t) -> int64_t {
    unsafe {
        ...
        let mut steps = int64_t::from(crate::src::nvim::math::trim_to_int(count / sw_val));
        let extra = crate::src::nvim::math::trim_to_int(count % sw_val);
...
pub unsafe fn shift_line(left: bool, round: bool, amount: c_int, call_changed_bytes: bool) {
    unsafe {
        ...
        let indent = crate::src::nvim::math::trim_to_int(count);
