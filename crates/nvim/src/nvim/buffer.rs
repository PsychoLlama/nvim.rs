...
use crate::src::nvim::types::{
    ...
    MetaIndex, OptInt, OptVal, OptValData, OptValType, ScopeType, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_14, StlClickRecord, StlFlag, String_0,
    StringBuilder, Timestamp, TriState, UndoObjectType, VarLockStatus, VarType, WinInfo, WinSplit,
    WinStyle, aco_save_T, auto_event, bfa_values, bln_values, buf_T, bufref_T, cleanup_T,
    cmd_addr_T, colnr_T, cstack_T, dictitem_T, dobuf_action_values, dobuf_start_values, etype_T,
    exarg_T, except_T, except_type_T, fmark_T, fmarkv_T, fuzmatch_str_T, garray_T, getf_values,
    handle_T, hashitem_T, int16_t, int64_t, intmax_t, linenr_T, memfile_T, pos_T, ptr_t, ptrdiff_t,
