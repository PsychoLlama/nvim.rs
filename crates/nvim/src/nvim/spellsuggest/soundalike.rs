...
use crate::src::nvim::spell::{allcap_copy, make_case_word, spell_soundfold};
use crate::src::nvim::spellsuggest::collect::add_suggestion;
...
pub unsafe fn suggest_try_soundalike_prep() {
    ...
    unsafe {
        for lp in crate::src::nvim::spellsuggest::window_langs() {
...
pub unsafe fn add_sound_suggest(
    ...
    unsafe {
        ...
        let goodword_len = crate::src::nvim::os::libc::strlen(goodword) as usize;
