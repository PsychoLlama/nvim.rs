...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, CharBoundsOff, CharInfo, Direction, EvalFuncData, FloatRelative,
    GraphemeState, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_15,
    StrCharInfo, VarLockStatus, VarType, WinSplit, WinStyle, colnr_T, expand_T, iconv_t, int8_t,
    int32_t, int64_t, list_T, listitem_T, pos_T, ptrdiff_t, schar_T, size_t, ssize_t, typval_T,
    uint8_t, uint32_t, uint64_t, uintptr_t, utf8proc_int32_t, varnumber_T, vimconv_T, win_T,
    xp_prefix_T,
};
