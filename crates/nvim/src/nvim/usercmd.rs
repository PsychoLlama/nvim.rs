...
use crate::src::nvim::types::{
    AlignTextPos, Arena, BoolVarValue, CMD_index, Dict, Direction, FloatRelative, Integer, LuaRef,
    Object, OptInt, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12,
    String_0, VarLockStatus, VarType, WinSplit, WinStyle, auto_event, buf_T, cmd_addr_T, cmdmod_T,
    estack_T, etype_T, exarg_T, except_type_T, expand_T, garray_T, int64_t, kObjectTypeBoolean,
    kObjectTypeDict, kObjectTypeInteger, kObjectTypeLuaRef, kObjectTypeNil, kObjectTypeString,
    key_value_pair, mod_entry_T, object, object_data as C2Rust_Unnamed, scid_T, sctx_T, size_t,
    ucmd_T, uint8_t, uint32_t, win_T, xp_prefix_T,
};
