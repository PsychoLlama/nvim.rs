use crate::src::nvim::eval::typval::{
    GARRAY_EMPTY, tv_blob_get, tv_blob_len, tv_list_copyid, tv_list_first, tv_list_last,
    tv_list_len, tv_list_set_copyid,
};
use crate::src::nvim::eval::typval::{
...
use crate::src::nvim::types::{
    ListReaderState, MPConvPartialStage, MPConvStack, MPConvStackVal,
    ...
    MPConvStackVal_data_p as C2Rust_Unnamed_2, MPConvStackValType, MessagePackType, VAR_DICT,
    VAR_FLOAT, VAR_FUNC, VAR_LIST, VAR_NUMBER, VAR_STRING, VAR_UNLOCKED, blob_T, dict_T,
    dictitem_T, float_T, garray_T, hashitem_T, int64_t, kBoolVarTrue, list_T, listitem_T,
    partial_T, ptrdiff_t, size_t, typval_T, typval_vval_union, uint8_t, uint64_t, varnumber_T,
};
use core::ffi::c_char;
