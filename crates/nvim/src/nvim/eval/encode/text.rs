...
use crate::src::nvim::eval::encode::did_echo_string_emsg;
...
use crate::src::nvim::types::{
    blob_T, dict_T, float_T, garray_T, int64_t, ptrdiff_t, size_t, typval_T,
};
...
impl<const ECHO: bool> TextSink<'_, ECHO> {
    ...
    ///
    /// [`ConvFrame::container`]: crate::src::nvim::eval::typval_encode::ConvFrame::container
