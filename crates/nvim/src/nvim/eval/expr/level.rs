...
use crate::src::nvim::eval::vars::{check_vars, eval_variable, get_vim_var_partial};
use crate::src::nvim::eval::{
    ...
    FUNCEXE_INIT, NOTDONE, NUL, OK, VAR_BLOB, VAR_BOOL, VAR_FLOAT, VAR_FUNC, VAR_LIST, VAR_NUMBER,
    VAR_PARTIAL, VAR_STRING, VAR_UNKNOWN, VAR_UNLOCKED, e_expression_too_recursive_str, eval_dict,
    eval_env_var, eval_interp_string, eval_list, eval_lit_dict, eval_lit_string, eval_number,
    eval_option, eval_string, get_name_len, handle_subscript, kBoolVarFalse, kBoolVarTrue,
