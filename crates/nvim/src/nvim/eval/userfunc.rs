...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, CMD_index, Callback, Direction, EvalFuncDef, FloatRelative, LuaRef,
    OptInt, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_13, String_0,
    VarLockStatus, VarType, VimVarIndex, WinSplit, WinStyle, auto_event, blob_T, buf_T, buffblock,
    buffblock_T, buffheader_T, cmd_addr_T, colnr_T, cstack_T, dict_T, dictitem_T, estack_T,
    etype_T, evalarg_T, exarg_T, except_T, except_type_T, exception_state_T, expand_T,
    funccal_entry_T, funccall_S_fc_fixvar as C2Rust_Unnamed_7, funccall_T, funcdict_T, funcexe_T,
    garray_T, hashitem_T, hashtab_T, ht_stack_T, intmax_t, key_extra, linenr_T, list_T,
    list_stack_T, listitem_T, lval_T, partial_T, proftime_T, regmatch_T, regprog_T, save_redo_T,
    sctx_T, size_t, typval_T, typval_vval_union, ufunc_T, uint8_t, varnumber_T, xp_prefix_T,
};
