...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, CMD_index, EvalFuncData, ExtmarkOp, FILE, FileInfo, FloatRelative,
    OptInt, OptScope, OptVal, OptValData, OptValType, ScopeType, SpecialVarValue,
    StlClickDefinition_type_0 as C2Rust_Unnamed_13, String_0, TriState, UndoObjectType,
    VarLockStatus, VarType, WinSplit, WinStyle, aco_save_T, auto_event, buf_T, bufref_T,
    cmd_addr_T, colnr_T, cstack_T, diff_T, diffblock_S, diffline_S, diffline_T, diffline_change_S,
    diffline_change_T, exarg_T, garray_T, hlf_T, int32_t, linenr_T, mmfile_t, scid_T, size_t,
