...
pub use crate::src::nvim::types::{
    ...
    hashitem_T, hashtab_T, int64_t, internal_proc_cb, intmax_t, loop_0, multiqueue, proc,
    proc_exit_cb, proc_state_cb, pthread_mutex_t, pthread_rwlock_t, queue, rstream, sa_family_t,
    ...
    stream_read_cb, stream_uv as C2Rust_Unnamed_14, stream_write_cb, uint8_t, uint16_t, uint32_t,
    uint64_t, uintptr_t, uv__io_cb, uv__io_s, uv__io_t, uv__queue, uv__work, uv_alloc_cb,
