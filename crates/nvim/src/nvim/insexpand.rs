...
use crate::src::nvim::main::{
    ...
    p_tsrfu, p_wic, p_ws, redraw_cmdline, redraw_mode, sc_col, test_disable_char_avail, textlock,
};
...
use crate::src::nvim::types::{
    AlignTextPos, Arena, BoolVarValue, Callback, Callback_data as C2Rust_Unnamed_5, Direction,
    EvalFuncData, ExtmarkOp, ExtmarkUndoObject, FILE, FloatRelative, ListLenSpecials, MotionType,
    OptInt, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_13, String_0,
    TriState, UndoObjectType, VarLockStatus, VarType, VimVarIndex, WinSplit, WinStyle, auto_event,
    buf_T, colnr_T, dict_T, dictitem_T, expand_T, extmark_undo_vec_t, garray_T, hashitem_T,
    hashtab_T, hlf_T, ht_stack_T, key_extra, linenr_T, list_T, list_stack_T, listitem_T, optset_T,
    pos_T, ptrdiff_t, pumitem_T, regmatch_T, regprog_T, save_v_event_T, sctx_T, searchit_arg_T,
    size_t, smt_T, typval_T, typval_vval_union, uint8_t, uint64_t, varnumber_T, win_T, xp_prefix_T,
    yankreg_T,
};
