...
use super::{
    CAR, Ctrl_H, E_SUBSTITUTE_NESTING_TOO_DEEP, K_SPECIAL, MAXCOL, NL, NUL, REGSUB_BACKSLASH,
    REGSUB_COPY, REGSUB_MAGIC, TAB, VAR_FIXED, VAR_FUNC, VAR_LIST, VAR_PARTIAL, VAR_STRING,
    VAR_UNKNOWN, can_f_submatch, prog_magic_wrong, reg_getline, reg_getline_len, reg_prev_sub,
    reg_prev_sublen, regsubmatch_T, rex, rsm,
};
