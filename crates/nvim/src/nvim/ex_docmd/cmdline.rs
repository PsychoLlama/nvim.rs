...
use crate::src::nvim::debugger::{dbg_breakpoint, dbg_find_breakpoint, do_debug};
use crate::src::nvim::eval::userfunc::{
    func_breakpoint, func_dbg_tick, func_has_abort, func_has_ended, func_level, func_name,
    get_func_line,
};
use crate::src::nvim::ex_docmd::onecmd::do_one_cmd;
use crate::src::nvim::ex_docmd::source::{
...
use crate::src::nvim::ex_getln::{
    getexline, ui_ext_cmdline_block_append, ui_ext_cmdline_block_leave,
};
...
use crate::src::nvim::message::{emsg, msg_start, wait_return};
use crate::src::nvim::os::input::line_breakcheck;
use crate::src::nvim::os::libc::{gettext, memmove, memset, strlen};
use crate::src::nvim::profile::{
    func_line_end, func_line_start, script_line_end, script_line_start,
};
...
pub unsafe fn do_cmdline(
    ...
    unsafe {
        ...
        static RECURSIVE: crate::src::nvim::global_cell::GlobalCell<c_int> =
            crate::src::nvim::global_cell::GlobalCell::new(0);
