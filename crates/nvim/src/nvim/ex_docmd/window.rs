...
use crate::src::nvim::drawscreen::{UPD_CLEAR, UPD_VALID, screen_resize};
...
use crate::src::nvim::winlayer::{Buf, TabPage, Win, tabs, windows, windows_in_tab};
...
impl Ex {
    ...
    fn is(self, cmd: crate::src::nvim::types::cmdidx_T) -> bool {
