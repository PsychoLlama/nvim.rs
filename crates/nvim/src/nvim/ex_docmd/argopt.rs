...
use crate::src::nvim::charset::{getdigits, skipwhite};
...
use crate::src::nvim::ex_docmd::scan::skip_cmd_arg;
...
pub(crate) unsafe extern "C" fn get_bad_name(_xp: *mut expand_T, idx: c_int) -> *mut c_char {
...
///
/// Keeps `extern "C"`: installed as a `CompleteListItemGetter`.
pub(crate) unsafe extern "C" fn get_argopt_name(_xp: *mut expand_T, idx: c_int) -> *mut c_char {
    const VALUES: [&CStr; 7] = [
        c"fileformat=",
        c"encoding=",
        c"binary",
