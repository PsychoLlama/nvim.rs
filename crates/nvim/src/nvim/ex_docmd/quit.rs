...
use crate::src::nvim::ex_docmd::{
    ...
    CMD_only, CMD_tabclose, CMD_tabonly, CMD_wq, Ctrl_C, DOBUF_DEL, DOBUF_UNLOAD, DOBUF_WIPE,
    EXIT_FAILURE, FAIL, KE_IGNORE, KE_XF1, KE_XF2, NUL, OK,
};
...
use crate::src::nvim::types::{
    CMOD_CONFIRM, Integer, VV_EXITREASON, buf_T, bufref_T, exarg_T, linenr_T, ptrdiff_t, tabpage_T,
    win_T,
};
