...
use crate::src::nvim::autocmd::{EVENT_FILECHANGEDRO, apply_autocmds};
...
use crate::src::nvim::decoration::{kMTMetaInline, kMTMetaLines};
...
use crate::src::nvim::types::{
    AdditionalData, AlignTextPos, BoolVarValue, ExtmarkOp, FloatRelative, GraphemeState, MarkTree,
    MotionType, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12,
    UndoObjectType, VarLockStatus, VarType, VimVarIndex, WinSplit, WinStyle, auto_event, bcount_t,
    buf_T, colnr_T, fmark_T, fmarkv_T, foldinfo_T, int64_t, linenr_T, oparg_T, pos_T, ptrdiff_t,
    size_t, ssize_t, tabpage_T, uint64_t, win_T,
};
...
pub unsafe extern "C" fn change_warning(mut buf: *mut buf_T, mut col: ::core::ffi::c_int) {
        ...
        && (*buf).b_p_ro != 0
    {
        ...
        msg_puts_hl(gettext(w_readonly.get()), HLF_W, true_0 != 0);
