...
#[cfg(test)]
mod tests {
    use crate::src::nvim::types::VTermState;
    use crate::src::nvim::vterm::state::{BLANK_LINE, test_state};
    ...
    fn the_cursor_is_pulled_inside_the_screen_or_the_origin() {
        ...
        state.pos = crate::src::nvim::types::VTermPos { row: 99, col: -3 };
        state.clamp_cursor();
        ...
        state.mode.set_leftrightmargin(1);
        state.pos = crate::src::nvim::types::VTermPos { row: 0, col: 99 };
        state.clamp_cursor();
    ...
    fn the_cursor_is_only_in_the_scroll_region_within_both_margins() {
        ...
        state.pos = crate::src::nvim::types::VTermPos { row: 3, col: 5 };
        assert!(state.cursor_in_scroll_region());
        state.pos.row = 6;
        assert!(!state.cursor_in_scroll_region());
        state.pos.row = 1;
        assert!(!state.cursor_in_scroll_region());
        state.pos = crate::src::nvim::types::VTermPos { row: 3, col: 10 };
        assert!(!state.cursor_in_scroll_region());
        state.pos.col = 3;
        assert!(!state.cursor_in_scroll_region());
    }
