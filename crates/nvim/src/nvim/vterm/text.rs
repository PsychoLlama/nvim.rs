...
use crate::src::nvim::types::{VTermRect, VTermState, schar_T};
use crate::src::nvim::vterm::geometry::{DHL_BOTTOM, DHL_OFF, DHL_TOP, DWL_OFF, DWL_ON};
use crate::src::nvim::vterm::mode;
use crate::src::nvim::vterm::pen::save_pen;
use crate::src::nvim::vterm::state::{PenChange, is_composing};
...
fn screen_alignment_test(state: &mut VTermState) {
    ...
    for row in 0..state.rows {
        for col in 0..state.row_width(row) {
            let pos = crate::src::nvim::types::VTermPos { row, col };
