...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, CMD_index, CdCause, FILE, FloatRelative, OptInt, ScopeType,
    SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12, VarLockStatus, VarType,
    VimVarIndex, WinSplit, WinStyle, aentry_T, auto_event, buf_T, cmd_addr_T, dict_T, dictitem_T,
    exarg_T, float_T, frame_T, garray_T, hashitem_T, hashtab_T, int64_t, ptrdiff_t, size_t,
    tabpage_T, var_flavour_T, win_T,
};
