...
pub(super) const PART: [vimoption_T; 78] = [
    ...
    vimoption_T {
        ...
        values: accepted(&opt_ambw_values),
        values_len: 2,
    ...
    vimoption_T {
        ...
        values: accepted(&opt_bkc_values),
        values_len: 5,
    ...
    vimoption_T {
        ...
        values: accepted(&opt_briopt_values),
        values_len: 5,
    ...
    vimoption_T {
        ...
        values: accepted(&opt_cmp_values),
        values_len: 2,
        opt_did_set_cb: Some(did_set_str_generic),
        opt_expand_cb: Some(expand_set_str_generic),
    ...
    vimoption_T {
        ...
        values: accepted(&opt_cpt_values),
        values_len: 15,
    ...
    vimoption_T {
        ...
        values: accepted(&opt_cot_values),
        values_len: 11,
    ...
    vimoption_T {
        ...
        var: OptVar::OwnDefault,
        immutable: true,
        values: accepted(&opt_csl_values),
        values_len: 3,
        def_val: string(c""),
        ..BLANK
    },
    ...
    vimoption_T {
        ...
        values: accepted(&opt_culopt_values),
        values_len: 4,
    ...
    vimoption_T {
        ...
        values: accepted(&opt_debug_values),
        values_len: 3,
        opt_did_set_cb: Some(did_set_str_generic),
        opt_expand_cb: Some(expand_set_str_generic),
        def_val: string(c""),
    ...
    vimoption_T {
        ...
        values: accepted(&opt_dip_values),
        values_len: 19,
    ...
    vimoption_T {
        ...
        values: accepted(&opt_ead_values),
        values_len: 3,
        opt_did_set_cb: Some(did_set_str_generic),
        opt_expand_cb: Some(expand_set_str_generic),
        def_val: string(c"both"),
