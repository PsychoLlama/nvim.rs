...
static nv_cmds: GlobalCell<[nv_cmd; 188]> = GlobalCell::new([
    ...
    nv_cmd {
        ...
        cmd_arg: BACKWARD as c_int as int16_t,
    },
    nv_cmd {
        cmd_char: Ctrl_C,
    ...
    nv_cmd {
        ...
        cmd_func: Some(nv_page as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: NV_STS as uint16_t,
        cmd_arg: FORWARD as c_int as int16_t,
    },
    nv_cmd {
        cmd_char: Ctrl_G,
    ...
    nv_cmd {
        ...
        cmd_flags: 0 as uint16_t,
        cmd_arg: SEARCH_REV as c_int as int16_t,
    },
    nv_cmd {
        cmd_char: 'O' as c_int,
    ...
    nv_cmd {
        ...
        cmd_func: Some(nv_beginline as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: (BL_WHITE as c_int | BL_FIX as c_int) as int16_t,
    },
    nv_cmd {
        cmd_char: '_' as c_int,
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MOUSEUP as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mousescroll as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: MSCR_UP as c_int as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MOUSEDOWN as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mousescroll as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: MSCR_DOWN as c_int as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MOUSELEFT as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mousescroll as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: MSCR_LEFT as c_int as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MOUSERIGHT as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mousescroll as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: MSCR_RIGHT as c_int as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_LEFTMOUSE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_LEFTMOUSE_NM as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_LEFTDRAG as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_LEFTRELEASE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_LEFTRELEASE_NM as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MOUSEMOVE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MIDDLEMOUSE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MIDDLEDRAG as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_MIDDLERELEASE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_RIGHTMOUSE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_RIGHTDRAG as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_RIGHTRELEASE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_X1MOUSE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_X1DRAG as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_X1RELEASE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_X2MOUSE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_X2DRAG as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_X2RELEASE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_mouse as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_IGNORE as c_int) << 8 as c_int)),
        cmd_func: Some(nv_ignore as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: NV_KEEPREG as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_NOP as c_int) << 8 as c_int)),
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_KINS as c_int) << 8 as c_int)),
        cmd_func: Some(nv_edit as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_S_UP as c_int) << 8 as c_int)),
        cmd_func: Some(nv_page as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_S_DOWN as c_int) << 8 as c_int)),
        cmd_func: Some(nv_page as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: NV_SS as uint16_t,
        cmd_arg: FORWARD as c_int as int16_t,
    },
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_C_LEFT as c_int) << 8 as c_int)),
        cmd_func: Some(nv_bck_word as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_C_RIGHT as c_int) << 8 as c_int)),
        cmd_func: Some(nv_wordcmd as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: (NV_SSS | NV_RL | NV_STS) as uint16_t,
        cmd_arg: true_0 as int16_t,
    },
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_C_END as c_int) << 8 as c_int)),
        cmd_func: Some(nv_end as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: (NV_SSS | NV_STS) as uint16_t,
        cmd_arg: true_0 as int16_t,
    },
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_C_HOME as c_int) << 8 as c_int)),
        cmd_func: Some(nv_goto as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: (NV_SSS | NV_STS) as uint16_t,
        cmd_arg: false_0 as int16_t,
    },
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_KDEL as c_int) << 8 as c_int)),
        cmd_func: Some(nv_abbrev as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_XF1 as c_int) << 8 as c_int)),
        cmd_func: Some(nv_help as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: NV_NCW as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    ...
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_EVENT as c_int) << 8 as c_int)),
        cmd_func: Some(nv_event as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: NV_KEEPREG as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_COMMAND as c_int) << 8 as c_int)),
        cmd_func: Some(nv_colon as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
    nv_cmd {
        cmd_char: -(253 as c_int + ((KE_LUA as c_int) << 8 as c_int)),
        cmd_func: Some(nv_colon as unsafe extern "C" fn(*mut cmdarg_T) -> ()),
        cmd_flags: 0 as uint16_t,
        cmd_arg: 0 as int16_t,
    },
