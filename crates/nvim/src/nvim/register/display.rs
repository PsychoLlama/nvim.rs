    ...
    unsafe {
            ...
            }
        {
            ...
            if l > 1 as ::core::ffi::c_int {
                msg_outtrans_len(p, l, 0 as ::core::ffi::c_int, false);
...
pub unsafe fn ex_display(mut eap: *mut exarg_T) {
    unsafe {
                        ...
                        if do_show as ::core::ffi::c_int != 0 || (*yb).y_size == 0 as size_t {
                            ...
                            while j_0 < (*yb).y_size && n > 1 as ::core::ffi::c_int {
                                ...
                                while *p as ::core::ffi::c_int != NUL && {
                                    ...
                                    msg_outtrans_len(p, clen, 0 as ::core::ffi::c_int, false);
        ...
        {
            msg_puts(c"\n  c  \":   ".as_ptr());
            dis_msg(last_cmdline.get(), false);
        }
        ...
        {
            msg_puts(c"\n  c  \"%   ".as_ptr());
            dis_msg((*curbuf.get()).b_fname, false);
        }
