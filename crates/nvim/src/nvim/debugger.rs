...
use crate::src::nvim::types::{
    AlignTextPos, BoolVarValue, CMD_index, Callback, Callback_data as C2Rust_Unnamed_5,
    FloatRelative, ScopeType, SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12,
    String_0, VarLockStatus, VarType, WinSplit, WinStyle, auto_event, buf_T, buffblock,
    buffblock_T, buffheader_T, cmd_addr_T, colnr_T, estack_T, estack_arg_T, etype_T, exarg_T,
    except_type_T, exprtype_T, garray_T, int32_t, int64_t, key_extra, linenr_T, regprog_T, size_t,
