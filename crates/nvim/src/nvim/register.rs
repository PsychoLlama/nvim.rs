...
use crate::src::nvim::types::{
    AdditionalData, AlignTextPos, Arena, BoolVarValue, CMD_index, CharsizeArg, CharsizeKind,
    Direction, ExtmarkOp, FloatRelative, GRegFlags, MotionType, OptInt, RemapValues, ScopeType,
    SpecialVarValue, StlClickDefinition_type_0 as C2Rust_Unnamed_12, StrCharInfo, String_0,
    Timestamp, UndoObjectType, VarLockStatus, VarType, WinSplit, WinStyle, auto_event, bcount_t,
    block_def, buf_T, cmd_addr_T, colnr_T, dict_T, exarg_T, garray_T, hashitem_T, hashtab_T,
    int64_t, linenr_T, list_T, oparg_T, pos_T, ptrdiff_t, save_v_event_T, size_t, ssize_t, uint8_t,
    yankreg_T,
};
