...
//! [`tui`](crate::src::nvim::tui::tui); what is here is the shape, and the
...
///
/// One of these exists per UI process. It is built by [`tui_start`](crate::src::nvim::tui::tui::tui_start) and
...
/// [`output`](crate::src::nvim::tui::output),
/// [`paint`](crate::src::nvim::tui::paint)) are safe on the
...
/// about to add. [`output`](crate::src::nvim::tui::output) writes what is
/// here straight to
...
pub struct TermInput {
    ...
    /// [`input`](crate::src::nvim::tui::input)'s `PASTE_*`.
    pub paste: i8,
