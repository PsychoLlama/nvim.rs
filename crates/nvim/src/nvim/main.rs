...
use crate::src::nvim::types::{
    ...
    AdditionalData, Array, Callback, Callback_data, CallbackType, DecorRangeSlot,
    DecorSignHighlight, DecorState, DecorState_ranges_i, DecorState_slots, FILE, GridView,
    ListLenSpecials, Loop, LuaRef, LuaRetMode, MTNode, MTPos, Map_String_int, Map_int_ptr_t,
    Map_uint64_t_ptr_t, MapHash, MarkTreeIter, MarkTreeIter_s, MultiQueue, NS, Object, OptInt,
    OptValType, Proc, RgbValue, ScreenGrid, Set_String, Set_int, Set_uint32_t, Set_uint64_t,
    StlClickDefinition, String_0, TriState, VarLockStatus, VarType, VimVarIndex, WinExtmark,
    XDGVarType, alist_T, aucmdwin_T, bln_values, buf_T, bufref_T, caller_scope, cmdmod_T, colnr_T,
    disptick_T, estack_T, estack_T_es_info, etype_T, evalarg_T, except_T, file_comparison, fmark_T,
    fmarkv_T, frame_T, garray_T, handle_T, hlf_T, int16_t, int32_t, int64_t, key_extra, linenr_T,
    lpos_T, match_T, msglist_T, nlua_ref_state_t, nvim_stats_s, optmagic_T, pos_T, proftime_T,
    pthread_mutex_t, pthread_rwlock_t, ptr_t, qf_info_T, reg_extmatch_T, regmatch_T, regmmatch_T,
