...
use crate::src::nvim::types::{
    ...
    TriState, VarLockStatus, VarType, VimVarIndex, WinExtmark, XDGVarType, alist_T, aucmdwin_T,
    ...
    garray_T, handle_T, hlf_T, int16_t, int32_t, int64_t, key_extra, linenr_T, lpos_T, match_T,
    msglist_T, nlua_ref_state_t, nvim_stats_s, optmagic_T, pos_T, proftime_T, pthread_mutex_t,
    pthread_rwlock_t, ptr_t, qf_info_T, reg_extmatch_T, regmatch_T, regmmatch_T, regprog_T,
