...
use crate::src::nvim::keycodes::{
    K_IGNORE, K_LEFTDRAG, K_LEFTMOUSE, K_LEFTRELEASE, K_MIDDLEDRAG, K_MIDDLEMOUSE, K_MIDDLERELEASE,
    K_MOUSEDOWN, K_MOUSELEFT, K_MOUSEMOVE, K_MOUSERIGHT, K_MOUSEUP, K_RIGHTDRAG, K_RIGHTMOUSE,
    K_RIGHTRELEASE, K_X1MOUSE, K_X2MOUSE,
};
use core::ffi::c_int;
use core::ptr;
