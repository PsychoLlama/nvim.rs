...
impl CondStack {
    ...
    /// active catch clause.
    pub fn pending_exception(&self, idx: usize) -> *mut Exception {
        self.cs_pend[idx].cast::<Exception>()
    }

    /// Postpone an exception at level `idx`.
    pub fn set_pending_exception(&mut self, idx: usize, exception: *mut Exception) {
...
pub struct ExceptionState {
    pub estate_current_exception: *mut Exception,
