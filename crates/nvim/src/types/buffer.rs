...
/// works: the buffer-local user commands are a `Vec` and every `b_p_*`
/// string option is an `Option<XString>`. Each raw pointer that is left is
/// either a borrowed edge into the graph or an allocation this buffer
/// releases in `free_buffer`, and duplicating one would make a second owner
/// of all of them.
///
/// **The buffer is allocated zeroed** (`buffer::list::alloc_unregistered_buffer`),
/// and all-zero bytes are `None` for every `Option<XString>` here: that is
...
pub struct Buffer {
    ...
    pub b_p_bkc: Option<XString>,
    pub b_bkc_flags: ::core::ffi::c_uint,
    pub b_p_ci: ::core::ffi::c_int,
    pub b_p_bin: ::core::ffi::c_int,
    pub b_p_bomb: ::core::ffi::c_int,
    pub b_p_bh: Option<XString>,
    pub b_p_bt: Option<XString>,
    pub b_p_busy: OptInt,
    pub b_has_qf_entry: ::core::ffi::c_int,
    pub b_p_bl: ::core::ffi::c_int,
    pub b_p_channel: OptInt,
    pub b_p_cin: ::core::ffi::c_int,
    pub b_p_cino: Option<XString>,
    pub b_p_cink: Option<XString>,
    pub b_p_cinw: Option<XString>,
    pub b_p_cinsd: Option<XString>,
    pub b_p_com: Option<XString>,
    pub b_p_cms: Option<XString>,
    pub b_p_cot: Option<XString>,
    pub b_cot_flags: ::core::ffi::c_uint,
    pub b_p_cpt: Option<XString>,
    pub b_p_cpt_cb: *mut Callback,
    pub b_p_cpt_count: ::core::ffi::c_int,
    pub b_p_cfu: Option<XString>,
    pub b_cfu_cb: Callback,
    pub b_p_ofu: Option<XString>,
    pub b_ofu_cb: Callback,
    pub b_p_tfu: Option<XString>,
    pub b_tfu_cb: Callback,
    pub b_p_ffu: Option<XString>,
    ...
    pub b_p_fenc: Option<XString>,
    pub b_p_ff: Option<XString>,
    pub b_p_ft: Option<XString>,
    pub b_p_fo: Option<XString>,
    pub b_p_flp: Option<XString>,
    pub b_p_inf: ::core::ffi::c_int,
    pub b_p_isk: Option<XString>,
    pub b_p_def: Option<XString>,
    pub b_p_inc: Option<XString>,
    pub b_p_inex: Option<XString>,
    pub b_p_inex_flags: uint32_t,
    pub b_p_inde: Option<XString>,
    pub b_p_inde_flags: uint32_t,
    pub b_p_indk: Option<XString>,
    pub b_p_fp: Option<XString>,
    pub b_p_fex: Option<XString>,
    pub b_p_fex_flags: uint32_t,
    pub b_p_fs: ::core::ffi::c_int,
    pub b_p_kp: Option<XString>,
    pub b_p_lisp: ::core::ffi::c_int,
    pub b_p_lop: Option<XString>,
    pub b_p_menc: Option<XString>,
    pub b_p_mps: Option<XString>,
    pub b_p_ml: ::core::ffi::c_int,
    pub b_p_ml_nobin: ::core::ffi::c_int,
    pub b_p_ma: ::core::ffi::c_int,
    pub b_p_nf: Option<XString>,
    pub b_p_pi: ::core::ffi::c_int,
    pub b_p_qe: Option<XString>,
    ...
    pub b_p_sua: Option<XString>,
    pub b_p_swf: ::core::ffi::c_int,
    pub b_p_smc: OptInt,
    pub b_p_syn: Option<XString>,
    pub b_p_ts: OptInt,
    pub b_p_tw: OptInt,
    ...
    pub b_p_vsts: Option<XString>,
    pub b_p_vsts_array: *mut ColNr,
    pub b_p_vsts_nopaste: Option<XString>,
    pub b_p_vts: Option<XString>,
    pub b_p_vts_array: *mut ColNr,
    pub b_p_keymap: Option<XString>,
    pub b_p_gefm: Option<XString>,
    pub b_p_gp: Option<XString>,
    pub b_p_mp: Option<XString>,
    pub b_p_efm: Option<XString>,
    pub b_p_ep: Option<XString>,
    pub b_p_path: Option<XString>,
    pub b_p_ar: ::core::ffi::c_int,
    pub b_p_tags: Option<XString>,
    pub b_p_tc: Option<XString>,
    pub b_tc_flags: ::core::ffi::c_uint,
    pub b_p_dict: Option<XString>,
    pub b_p_dia: Option<XString>,
    pub b_p_tsr: Option<XString>,
    pub b_p_tsrfu: Option<XString>,
    pub b_tsrfu_cb: Callback,
    pub b_p_ul: OptInt,
    pub b_p_udf: ::core::ffi::c_int,
    pub b_p_lw: Option<XString>,
...
pub struct SynBlock {
    ...
    pub b_p_spc: Option<XString>,
    pub b_cap_prog: *mut RegProg,
    pub b_p_spf: Option<XString>,
    pub b_p_spl: Option<XString>,
    pub b_p_spo: Option<XString>,
    pub b_p_spo_flags: ::core::ffi::c_uint,
    pub b_cjk: ::core::ffi::c_int,
    pub b_syn_chartab: [uint8_t; 32],
    pub b_syn_isk: Option<XString>,
}
