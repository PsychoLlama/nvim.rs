...
use crate::main::{
    Columns, IObuff, KeyStuffed, KeyTyped, Rows, State, allbuf_lock, c_bytes, cmd_silent,
    cmdline_row, cmdline_star, cmdline_was_last_drawn, cmdline_win, cmdmod, cmdmsg_rl, cmdpreview,
    cmdwin_buf, cmdwin_level, cmdwin_old_curwin, cmdwin_result, cmdwin_type, cmdwin_win, curbuf,
    current_sctx, curwin, did_emsg, e_cannot_edit_other_buf, e_cmdwin, e_command_too_recursive,
    e_intern2, e_invarg, e_positive, e_textlock, emsg_on_display, emsg_silent, ex_normal_busy,
    exec_from_reg, exmode_active, firstwin, global_busy, got_int, highlight_match, lines_left,
    magic_overruled, mod_mask, mouse_col, mouse_row, msg_col, msg_didout, msg_no_more, msg_row,
    msg_scroll, msg_scrolled, need_wait_return, new_last_cmdline, no_abbr, no_hlsearch, p_ari,
