...
use crate::vterm::pen::{CSI_ARG_MASK, CSI_ARG_MISSING};
use crate::vterm::state::{PenChange, vterm_primary_device_attr};
...
fn finish(state: &mut VTermState, oldpos: crate::types::VTermPos, cancel: bool) -> Outcome {
    state.clamp_cursor();
