...
- nvim-highlight crate: rgb_blend, cterm_blend, color conversion, name_to_ctermcolor, name_to_color, coloridx_to_name, HlAttrs struct, hl_combine_ae, get_colors_force, hl_blend_attrs_compute
