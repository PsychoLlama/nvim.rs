//! Menu name classification utilities.
//!
//! This module provides functions to classify menu names by their type:
//! - Popup menus (start with "PopUp")
//! - Toolbar menus (start with "ToolBar")
//! - Window bar menus (start with "WinBar")
//! - Menubar menus (none of the above and not hidden)
//! - Separator items (start and end with '-')
