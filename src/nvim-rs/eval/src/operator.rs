...
/// FFI export: Check if operator is unary.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_is_unary(value: c_int) -> c_int {
    c_int::from(Operator::from_raw(value).is_unary())
}

/// FFI export: Check if operator is binary.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_is_binary(value: c_int) -> c_int {
    c_int::from(Operator::from_raw(value).is_binary())
}

/// FFI export: Get Operator::Invalid constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_invalid() -> c_int {
    Operator::Invalid.to_raw()
}

/// FFI export: Get Operator::Or constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_or() -> c_int {
    Operator::Or.to_raw()
}

/// FFI export: Get Operator::And constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_and() -> c_int {
    Operator::And.to_raw()
}

/// FFI export: Get Operator::Equal constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_equal() -> c_int {
    Operator::Equal.to_raw()
}

/// FFI export: Get Operator::Add constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_add() -> c_int {
    Operator::Add.to_raw()
}

/// FFI export: Get Operator::Subtract constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_subtract() -> c_int {
    Operator::Subtract.to_raw()
}

/// FFI export: Get Operator::Multiply constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_multiply() -> c_int {
    Operator::Multiply.to_raw()
}

/// FFI export: Get Operator::Divide constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_divide() -> c_int {
    Operator::Divide.to_raw()
}

/// FFI export: Get Operator::Concat constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_op_concat() -> c_int {
    Operator::Concat.to_raw()
}

/// FFI export: Get CaseSensitivity::Option constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_case_option() -> c_int {
    CaseSensitivity::Option.to_raw()
}

/// FFI export: Get CaseSensitivity::Sensitive constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_case_sensitive() -> c_int {
    CaseSensitivity::Sensitive.to_raw()
}

/// FFI export: Get CaseSensitivity::Insensitive constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_eval_case_insensitive() -> c_int {
    CaseSensitivity::Insensitive.to_raw()
}

/// FFI export: Get precedence::TERNARY constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_ternary() -> c_int {
    precedence::TERNARY
}

/// FFI export: Get precedence::OR constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_or() -> c_int {
    precedence::OR
}

/// FFI export: Get precedence::AND constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_and() -> c_int {
    precedence::AND
}

/// FFI export: Get precedence::COMPARISON constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_comparison() -> c_int {
    precedence::COMPARISON
}

/// FFI export: Get precedence::ADDITIVE constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_additive() -> c_int {
    precedence::ADDITIVE
}

/// FFI export: Get precedence::MULTIPLICATIVE constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_multiplicative() -> c_int {
    precedence::MULTIPLICATIVE
}

/// FFI export: Get precedence::UNARY constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_unary() -> c_int {
    precedence::UNARY
}

/// FFI export: Get precedence::POSTFIX constant.
#[unsafe(no_mangle)]
pub extern "C" fn rs_prec_postfix() -> c_int {
    precedence::POSTFIX
}
