...
use crate::opt_index::{
    ...
    K_OPT_COMMENTSTRING, K_OPT_COMPLETE, K_OPT_COMPLETEFUNC, K_OPT_COMPLETESLASH, K_OPT_COPYINDENT,
    K_OPT_DEFINE, K_OPT_DICTIONARY, K_OPT_DIFFANCHORS, K_OPT_EQUALPRG, K_OPT_ERRORFORMAT,
    K_OPT_EXPANDTAB, K_OPT_FILETYPE, K_OPT_FINDFUNC, K_OPT_FIXENDOFLINE, K_OPT_FORMATEXPR,
