...
extern "C" {
    ...
    pub static mut p_langmap: *mut c_char;
    pub static mut p_km: *mut c_char;
    pub static mut p_bkc: *mut c_char;
    pub static mut p_path: *mut c_char;
    pub static mut p_cdpath: *mut c_char;
    pub static mut p_flp: *mut c_char;
    pub static mut p_cpt: *mut c_char;
    pub static mut p_cfu: *mut c_char;
    pub static mut p_ofu: *mut c_char;
    pub static mut p_tfu: *mut c_char;
    pub static mut p_com: *mut c_char;
    pub static mut p_cms: *mut c_char;
    pub static mut p_cink: *mut c_char;
    pub static mut p_cino: *mut c_char;
    pub static mut p_cinsd: *mut c_char;
    pub static mut p_lop: *mut c_char;
    pub static mut p_cinw: *mut c_char;
    pub static mut p_inde: *mut c_char;
    pub static mut p_indk: *mut c_char;
    pub static mut p_fex: *mut c_char;
    pub static mut p_sua: *mut c_char;
    pub static mut p_keymap: *mut c_char;
    pub static mut p_qe: *mut c_char;
    pub static mut p_inex: *mut c_char;
    pub static mut p_spc: *mut c_char;
    pub static mut p_spf: *mut c_char;
    pub static mut p_spl: *mut c_char;
    pub static mut p_spo: *mut c_char;
    pub static mut p_vsts: *mut c_char;
    pub static mut p_vts: *mut c_char;
    pub static mut p_bs: *mut c_char;
    pub static mut p_ep: *mut c_char;
    pub static mut p_ffu: *mut c_char;
