...
extern "C" {
    ...
    fn rs_qf_restore_list(qi: QfInfoHandleMut, save_qfid: u32) -> c_int;
    ...
    fn nvim_vgr_jump_to_match(
        qi: QfInfoHandleMut,
        forceit: c_int,
        redraw_for_dummy: *mut bool,
        first_match_buf: BufHandle,
        target_dir: *mut c_char,
    );
