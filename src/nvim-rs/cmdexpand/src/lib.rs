...
// Backslash constants
#[no_mangle]
pub extern "C" fn rs_xp_bs_none() -> c_int {
    backslash::XP_BS_NONE
}

#[no_mangle]
pub extern "C" fn rs_xp_bs_one() -> c_int {
    backslash::XP_BS_ONE
}

#[no_mangle]
pub extern "C" fn rs_xp_bs_three() -> c_int {
    backslash::XP_BS_THREE
}

#[no_mangle]
pub extern "C" fn rs_xp_bs_comma() -> c_int {
    backslash::XP_BS_COMMA
}

// Wild mode constants
#[no_mangle]
pub extern "C" fn rs_wild_free() -> c_int {
    wild_mode::WILD_FREE
}

#[no_mangle]
pub extern "C" fn rs_wild_expand_free() -> c_int {
    wild_mode::WILD_EXPAND_FREE
}

#[no_mangle]
pub extern "C" fn rs_wild_expand_keep() -> c_int {
    wild_mode::WILD_EXPAND_KEEP
}

#[no_mangle]
pub extern "C" fn rs_wild_next() -> c_int {
    wild_mode::WILD_NEXT
}

#[no_mangle]
pub extern "C" fn rs_wild_prev() -> c_int {
    wild_mode::WILD_PREV
}

#[no_mangle]
pub extern "C" fn rs_wild_all() -> c_int {
    wild_mode::WILD_ALL
}

#[no_mangle]
pub extern "C" fn rs_wild_longest() -> c_int {
    wild_mode::WILD_LONGEST
}

#[no_mangle]
pub extern "C" fn rs_wild_all_keep() -> c_int {
    wild_mode::WILD_ALL_KEEP
}

#[no_mangle]
pub extern "C" fn rs_wild_cancel() -> c_int {
    wild_mode::WILD_CANCEL
}

#[no_mangle]
pub extern "C" fn rs_wild_apply() -> c_int {
    wild_mode::WILD_APPLY
}

#[no_mangle]
pub extern "C" fn rs_wild_pageup() -> c_int {
    wild_mode::WILD_PAGEUP
}

#[no_mangle]
pub extern "C" fn rs_wild_pagedown() -> c_int {
    wild_mode::WILD_PAGEDOWN
}

#[no_mangle]
pub extern "C" fn rs_wild_pum_want() -> c_int {
    wild_mode::WILD_PUM_WANT
}

// Wild options constants
#[no_mangle]
pub extern "C" fn rs_wild_list_notfound() -> c_int {
    wild_options::WILD_LIST_NOTFOUND
}

#[no_mangle]
pub extern "C" fn rs_wild_home_replace() -> c_int {
    wild_options::WILD_HOME_REPLACE
}

#[no_mangle]
pub extern "C" fn rs_wild_use_nl() -> c_int {
    wild_options::WILD_USE_NL
}

#[no_mangle]
pub extern "C" fn rs_wild_no_beep() -> c_int {
    wild_options::WILD_NO_BEEP
}

#[no_mangle]
pub extern "C" fn rs_wild_add_slash() -> c_int {
    wild_options::WILD_ADD_SLASH
}

#[no_mangle]
pub extern "C" fn rs_wild_keep_all() -> c_int {
    wild_options::WILD_KEEP_ALL
}

#[no_mangle]
pub extern "C" fn rs_wild_silent() -> c_int {
    wild_options::WILD_SILENT
}

#[no_mangle]
pub extern "C" fn rs_wild_escape() -> c_int {
    wild_options::WILD_ESCAPE
}

#[no_mangle]
pub extern "C" fn rs_wild_icase() -> c_int {
    wild_options::WILD_ICASE
}

#[no_mangle]
pub extern "C" fn rs_wild_alllinks() -> c_int {
    wild_options::WILD_ALLLINKS
}

#[no_mangle]
pub extern "C" fn rs_wild_ignore_completeslash() -> c_int {
    wild_options::WILD_IGNORE_COMPLETESLASH
}

#[no_mangle]
pub extern "C" fn rs_wild_noerror() -> c_int {
    wild_options::WILD_NOERROR
}

#[no_mangle]
pub extern "C" fn rs_wild_buflastused() -> c_int {
    wild_options::WILD_BUFLASTUSED
}

#[no_mangle]
pub extern "C" fn rs_buf_diff_filter() -> c_int {
    wild_options::BUF_DIFF_FILTER
}

#[no_mangle]
pub extern "C" fn rs_wild_noselect() -> c_int {
    wild_options::WILD_NOSELECT
}

#[no_mangle]
pub extern "C" fn rs_wild_may_expand_pattern() -> c_int {
    wild_options::WILD_MAY_EXPAND_PATTERN
}

#[no_mangle]
pub extern "C" fn rs_wild_func_trigger() -> c_int {
    wild_options::WILD_FUNC_TRIGGER
}

// Expand context constants
#[no_mangle]
pub extern "C" fn rs_expand_unsuccessful() -> c_int {
    ExpandContext::Unsuccessful.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_ok() -> c_int {
    ExpandContext::Ok.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_nothing() -> c_int {
    ExpandContext::Nothing.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_commands() -> c_int {
    ExpandContext::Commands.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_files() -> c_int {
    ExpandContext::Files.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_directories() -> c_int {
    ExpandContext::Directories.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_settings() -> c_int {
    ExpandContext::Settings.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_buffers() -> c_int {
    ExpandContext::Buffers.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_help() -> c_int {
    ExpandContext::Help.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_functions() -> c_int {
    ExpandContext::Functions.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_user_commands() -> c_int {
    ExpandContext::UserCommands.to_raw()
}

#[no_mangle]
pub extern "C" fn rs_expand_lua() -> c_int {
