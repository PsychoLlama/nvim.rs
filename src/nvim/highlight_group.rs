...
pub use crate::src::nvim::types::{
    ...
    bhdr_T, blob_T, blobvar_S, blocknr_T, buf_T, bufstate_T, chunksize_T, colnr_T,
    color_name_table_T, cstr_t, dict_T, dictvar_S, disptick_T, estack_T,
    ...
    msglist, msglist_T, mtnode_inner_s, mtnode_s, object, object_data as C2Rust_Unnamed_0,
