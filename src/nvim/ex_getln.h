...
// Phase 2 (ex_getln migration): cmdline block UI implemented in Rust
...
void rs_trigger_cmd_autocmd(int typechar, int evt);
int rs_cmdline_fire_leavepre_autocmd(void *s, int c_val);
