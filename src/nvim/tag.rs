...
pub use crate::src::nvim::types::{
    ...
    DecorVirtText_data as C2Rust_Unnamed_2, Direction, DoInRuntimepathCB, ExtmarkUndoObject,
    ...
    Map_uint64_t_ptr_t, MarkTree, MotionType, OptIndex, OptInt, OptValData, ScopeDictDictItem,
    ...
    Timestamp, TriState, UIExtension, VarLockStatus, VarType, VimVarIndex, VirtLines, VirtText,
    VirtTextChunk, VirtTextPos, WinConfig, WinInfo, WinSplit, WinStyle, Window, _IO_codecvt,
    _IO_lock_t, _IO_marker, _IO_wide_data, __off64_t, __off_t, __time_t, alist_T, auto_event,
    bhdr_T, blob_T, blobvar_S, blocknr_T, buf_T, bufstate_T, chunksize_T, cmd_addr_T, cmdidx_T,
    cmdmod_T, colnr_T, cstack_T, cstack_T_cs_pend as C2Rust_Unnamed_17, dict_T, dictitem_T,
    dictvar_S, diff_T, diffblock_S, disptick_T, eslist_T, eslist_elem, event_T, exarg, exarg_T,
    ...
    winopt_T, wline_T, xfmark_T, xp_prefix_T, FILE, QUEUE, _IO_FILE,
};
extern "C" {
    fn __assert_fail(
