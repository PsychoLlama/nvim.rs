...
// nvim_set_cmdwin_type, nvim_set_cmdwin_level, nvim_set_cmdwin_win, nvim_set_cmdwin_old_curwin,
// nvim_set_cmdwin_buf, nvim_get_cmdwin_result: exported from Rust (window crate, globals.rs)
