...
// scale_number: migrated to Rust (lexer.rs)

// viml_pexpr_next_token: migrated to Rust (lexer.rs)
// Forward declaration so viml_pexpr_parse can call it (definition is in libnvim_rs.a).
LexExprToken viml_pexpr_next_token(ParserState *pstate, int flags)
  FUNC_ATTR_WARN_UNUSED_RESULT;

// eltkn_type_tab, eltkn_mul_type_tab, eltkn_opt_scope_tab: local to repr.rs (Rust)
...
// intchar2str: migrated to Rust (repr.rs)
// viml_pexpr_repr_token: migrated to Rust (repr.rs)
// viml_pexpr_free_ast: migrated to Rust (ast.rs)
