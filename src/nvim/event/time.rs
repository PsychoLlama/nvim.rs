...
pub use crate::src::nvim::types::{
    ...
    stream_close_cb, stream_read_cb, stream_uv as C2Rust_Unnamed_12, stream_write_cb, time_cb,
    time_watcher, uint8_t, uint64_t, uv__io_cb, uv__io_s, uv__io_t, uv__queue, uv_alloc_cb,
