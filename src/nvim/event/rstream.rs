...
pub use crate::src::nvim::types::{
    ...
    __pthread_rwlock_arch_t, __uid_t, Event, Loop, MultiQueue, RStream, Stream, argv_callback,
    gid_t, int64_t, loop_0, mode_t, multiqueue, off_t, pthread_mutex_t, pthread_rwlock_t, rstream,
    size_t, ssize_t, stream, stream_close_cb, stream_read_cb, stream_uv as C2Rust_Unnamed_10,
