...
pub use crate::src::nvim::types::{
    ...
    proc_state_cb, pthread_mutex_t, pthread_rwlock_t, queue, rstream, signal_cb, signal_close_cb,
    signal_watcher, size_t, ssize_t, stream, stream_close_cb, stream_read_cb,
    stream_uv as C2Rust_Unnamed_12, stream_write_cb, uint8_t, uint64_t, uv__io_cb, uv__io_s,
