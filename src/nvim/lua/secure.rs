...
unsafe extern "C" fn nlua_trust(
    ...
    lua_getfield(
        lstate,
        -1 as ::core::ffi::c_int,
        b"trust\0".as_ptr() as *const ::core::ffi::c_char,
    );
    lua_createtable(lstate, 0 as ::core::ffi::c_int, 0 as ::core::ffi::c_int);
    lua_pushstring(lstate, b"action\0".as_ptr() as *const ::core::ffi::c_char);
    lua_pushstring(lstate, action);
    lua_settable(lstate, -3 as ::core::ffi::c_int);
    if path.is_null() {
        lua_pushstring(lstate, b"bufnr\0".as_ptr() as *const ::core::ffi::c_char);
        lua_pushnumber(lstate, 0 as ::core::ffi::c_int as lua_Number);
        lua_settable(lstate, -3 as ::core::ffi::c_int);
    } else {
        lua_pushstring(lstate, b"path\0".as_ptr() as *const ::core::ffi::c_char);
    ...
    if nlua_pcall(lstate, 1 as ::core::ffi::c_int, 2 as ::core::ffi::c_int) != 0 {
        nlua_error(
            lstate,
            gettext(b"vim.secure.trust: %.*s\0".as_ptr() as *const ::core::ffi::c_char),
        );
        lua_settop(lstate, top);
        return false_0 != 0;
    }
    let mut success: bool = lua_toboolean(lstate, -2 as ::core::ffi::c_int) != 0;
    let mut msg: *const ::core::ffi::c_char = lua_tolstring(
        lstate,
        -1 as ::core::ffi::c_int,
    ...
    if !msg.is_null() {
        if success {
            if strcmp(action, b"allow\0".as_ptr() as *const ::core::ffi::c_char)
                == 0 as ::core::ffi::c_int
            {
                smsg(
                    0 as ::core::ffi::c_int,
            ...
            semsg(&raw const e_trustfile as *const ::core::ffi::c_char, msg);
        }
    }
    lua_settop(lstate, top);
    return success;
...
pub unsafe extern "C" fn ex_trust(mut eap: *mut exarg_T) {
    ...
    '_theend: {
        if strcmp(arg1, b"++deny\0".as_ptr() as *const ::core::ffi::c_char)
            == 0 as ::core::ffi::c_int
        {
            action = b"deny\0".as_ptr() as *const ::core::ffi::c_char;
        } else if strcmp(arg1, b"++remove\0".as_ptr() as *const ::core::ffi::c_char)
            == 0 as ::core::ffi::c_int
        {
            action = b"remove\0".as_ptr() as *const ::core::ffi::c_char;
        } else if *arg1 as ::core::ffi::c_int != NUL {
            semsg(&raw const e_invarg2 as *const ::core::ffi::c_char, arg1);
            break '_theend;
        }
        if *path.offset(0 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == NUL {
            path = ::core::ptr::null::<::core::ffi::c_char>();
        }
        nlua_trust(action, path);
    }
    xfree(arg1 as *mut ::core::ffi::c_void);
}
