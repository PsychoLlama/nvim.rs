...
pub use crate::src::nvim::types::{
    AdditionalData, AdditionalDataBuilder, AlignTextPos, Arena, Array, BoolVarValue, Boolean,
    BufUpdateCallbacks, Callback, CallbackType, Callback_data as C2Rust_Unnamed_7,
    ...
    VirtTextPos, WinConfig, WinInfo, WinSplit, WinStyle, Window, __compar_fn_t, __gid_t, __time_t,
    __uid_t, alist_T, bhdr_T, bln_values, blob_T, blobvar_S, blocknr_T, buf_T, bufstate_T,
