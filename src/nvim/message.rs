...
pub use crate::src::nvim::types::{
    ...
    loop_0_children as C2Rust_Unnamed_25, lpos_T, mapblock, mapblock_T, match_T, matchitem,
    matchitem_T, memfile_T, memline_T, mfdirty_T, msg_data, msglist, msglist_T, mtnode_inner_s,
    mtnode_s, multiqueue, object, object_data as C2Rust_Unnamed_11, partial_S, partial_T, pos_T,
    ...
    regprog, regprog_T, rstream, sattr_T, schar_T, scid_T, sctx_T, size_t, ssize_t, stream,
    stream_close_cb, stream_read_cb, stream_uv as C2Rust_Unnamed_26, stream_write_cb, syn_state,
...
extern "C" {
    ...
    static redrawing_cmdline: GlobalCell<bool>;
    static cmdline_was_last_drawn: GlobalCell<bool>;
    static cmdmsg_rl: GlobalCell<bool>;
    ...
    static msg_scrolled_ign: GlobalCell<bool>;
    ...
    static ex_exitval: GlobalCell<::core::ffi::c_int>;
    ...
    static msg_buf: GlobalCell<[::core::ffi::c_char; 480]>;
