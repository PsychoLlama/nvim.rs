...
pub use crate::src::nvim::types::{
    ...
    _IO_marker, _IO_wide_data, __off64_t, __off_t, __time_t, aentry_T, alist_T, auto_event, bhdr_T,
    blob_T, blobvar_S, blocknr_T, buf_T, bufstate_T, chunksize_T, cmd_addr_T, cmdidx_T, colnr_T,
    cstack_T, cstack_T_cs_pend as C2Rust_Unnamed_13, dict_T, dictitem_T, dictvar_S, diff_T,
