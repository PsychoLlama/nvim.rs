...
pub use crate::src::nvim::types::{
    ...
    Callback_data as C2Rust_Unnamed_5, CallbackType, CdCause, ChangedtickDictItem, DecorExt,
    DecorHighlightInline, DecorInlineData, DecorPriority, DecorVirtText,
    DecorVirtText_data as C2Rust_Unnamed_2, ExtmarkUndoObject, FILE, FileID, FloatAnchor,
    ...
    WinStyle, Window, aentry_T, alist_T, auto_event, bhdr_T, blob_T, blobvar_S, blocknr_T, buf_T,
    bufstate_T, chunksize_T, cmd_addr_T, cmdidx_T, colnr_T, cstack_T,
    cstack_T_cs_pend as C2Rust_Unnamed_13, dict_T, dictitem_T, dictvar_S, diff_T, diffblock_S,
