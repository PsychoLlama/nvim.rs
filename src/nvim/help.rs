...
use crate::src::nvim::main::{
    ...
    p_hlg, p_rtp, p_sb, restart_edit, Columns, IObuff, KeyTyped, NameBuff,
};
...
use crate::src::nvim::path::{add_pathsep, gen_expand_wildcards, path_full_compare, FreeWild};
...
pub use crate::src::nvim::types::{
    ...
    DecorVirtText_data as C2Rust_Unnamed_2, Dict, Direction, DoInRuntimepathCB, Error, ErrorType,
    ExtmarkUndoObject, FileComparison, FileID, Float, FloatAnchor, FloatRelative, GridView,
    Integer, Intersection, KeyValuePair, LineGetter, LuaRef, LuaRetMode, MTKey, MTNode, MTPos,
    MapHash, Map_int64_t_int64_t, Map_int64_t_ptr_t, Map_uint32_t_uint32_t, Map_uint64_t_ptr_t,
    MarkTree, Object, ObjectType, OptIndex, OptInt, OptVal, OptValData, OptValType,
    ...
    _IO_marker, _IO_wide_data, __compar_fn_t, __off64_t, __off_t, __time_t, alist_T, bhdr_T,
    ...
    mfdirty_T, mtnode_inner_s, mtnode_s, object, object_data as C2Rust_Unnamed_13, partial_S,
