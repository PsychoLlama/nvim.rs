...
pub use crate::src::nvim::types::{
    ...
    cmd_addr_T, cmdidx_T, cmdmod_T, colnr_T, cstack_T, cstack_T_cs_pend as C2Rust_Unnamed_16,
    ...
    wline_T, xfmark_T, xp_prefix_T, AdditionalData, AlignTextPos, Arena, Array, BoolVarValue,
    ...
    Direction, DoInRuntimepathCB, Error, ErrorType, ExtmarkUndoObject, FileComparison, FileID,
