...
pub use crate::src::nvim::types::{
    __compar_fn_t, __time_t, alist_T, auto_event, bhdr_T, blob_T, blobvar_S, blocknr_T, buf_T,
    ...
    eslist_T, eslist_elem, event_T, exarg, exarg_T, expand_T, extmark_undo_vec_t, fcs_chars_T,
