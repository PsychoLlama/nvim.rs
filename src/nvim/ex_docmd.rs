...
pub use crate::src::nvim::types::{
    ...
    RemapValues, RemoteUI, RpcState, RpcState_call_stack as C2Rust_Unnamed_40, ScopeDictDictItem,
    ...
    String_0, Terminal, Timestamp, TriState, UIExtension, Unpacker, VarLockStatus, VarType,
    VimVarIndex, VirtLines, VirtText, VirtTextChunk, VirtTextPos, WinConfig, WinInfo, WinSplit,
    WinStyle, Window, alist_T, auto_event, bhdr_T, blob_T, blobvar_S, blocknr_T, buf_T, buffblock,
    buffblock_T, buffheader_T, bufref_T, bufstate_T, chunksize_T, cleanup_T, cleanup_stuff,
    cmd_addr_T, cmdidx_T, cmdmod_T, colnr_T, consumed_blk, cstack_T,
    cstack_T_cs_pend as C2Rust_Unnamed_34, dict_T, dictvar_S, diff_T, diffblock_S, disptick_T,
    dobuf_action_values, dobuf_start_values, eslist_T, eslist_elem, estack_T,
    estack_T_es_info as C2Rust_Unnamed_55, estack_arg_T, etype_T, evalarg_T, event_T, exarg,
    exarg_T, except_T, except_type_T, expand_T, extmark_undo_vec_t, fcs_chars_T, file_buffer,
    ...
    llpos_T, loop_0, loop_0_children as C2Rust_Unnamed_28, lpos_T, mapblock, mapblock_T, match_T,
    matchitem, matchitem_T, memfile_T, memline_T, mfdirty_T, msglist, msglist_T, mtnode_inner_s,
    mtnode_s, multiqueue, object, object_data as C2Rust_Unnamed_14, oparg_T, optmagic_T, optset_T,
    ...
    reg_extmatch_T, regmatch_T, regmmatch_T, regprog, regprog_T, rstream, sattr_T, save_state_T,
    schar_T, scid_T, sctx_T, searchit_arg_T, size_t, ssize_t, stream, stream_close_cb,
    stream_read_cb, stream_uv as C2Rust_Unnamed_29, stream_write_cb, syn_state,
...
pub unsafe extern "C" fn get_bad_opt(
    ...
    } else if (*utf8len_tab.ptr())[*p as uint8_t as usize] as ::core::ffi::c_int
        == 1 as ::core::ffi::c_int
        && *p.offset(1 as ::core::ffi::c_int as isize) as ::core::ffi::c_int == NUL
    {
