...
pub use crate::src::nvim::types::{
    ...
    colnr_T, dict_T, dictvar_S, diff_T, diffblock_S, disptick_T, except_T, except_type_T,
    ...
    Integer, Intersection, KeyDict_win_text_height, KeyValuePair, LuaRef, LuaRetMode, MTKey,
