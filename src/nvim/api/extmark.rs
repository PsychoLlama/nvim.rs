...
pub use crate::src::nvim::types::{
    ...
    DecorProvider, DecorProvider_state as C2Rust_Unnamed_20, DecorRange, DecorRangeKind,
    DecorRangeSlot, DecorRange_data as C2Rust_Unnamed_24, DecorRange_data_ui as C2Rust_Unnamed_25,
