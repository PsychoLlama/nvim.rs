...
pub use crate::src::nvim::types::{
    ...
    dict_T, dictvar_S, disptick_T, eslist_T, eslist_elem, event_T, exarg, exarg_T, except_T,
    ...
    AlignTextPos, Arena, Array, ArrayBuilder, AutoCmd, AutoCmdVec, AutoPat, BoolVarValue, Boolean,
