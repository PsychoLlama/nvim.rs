...
extern int rs_match_add(win_T *wp, const char *grp, const char *pat, int prio, int id, const char *conceal_char);
extern int rs_match_add_pos(win_T *wp, const char *grp, int prio, int id, const char *conceal_char, const linenr_T *lnums, const colnr_T *cols, const int *lens, int count);
