...
pub use crate::src::nvim::types::{
    ...
    BufUpdateCallbacks, Buffer, CMD_index, CSType, Callback, CallbackType,
    ...
    alist_T, bhdr_T, blob_T, blobvar_S, blocknr_T, buf_T, bufstate_T, chunksize_T, cmd_addr_T,
    cmdidx_T, colnr_T, consumed_blk, cstack_T, cstack_T_cs_pend as C2Rust_Unnamed_16, dict_T,
    dictvar_S, diff_T, diffblock_S, disptick_T, eslist_T, eslist_elem, exarg, exarg_T,
