...
pub use crate::src::nvim::types::{
    ...
    cmdmod_T, colnr_T, dict_T, dictvar_S, diff_T, diffblock_S, disptick_T, extmark_undo_vec_t,
    ...
    MotionType, OptIndex, OptInt, ScopeDictDictItem, ScopeType, ScreenGrid, Set_int64_t,
