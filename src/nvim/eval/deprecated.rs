...
pub use crate::src::nvim::types::{
    ...
    fcs_chars_T, file_buffer, file_buffer_b_signcols as C2Rust_Unnamed_17,
    ...
    xfmark_T, AdditionalData, AlignTextPos, ApiDispatchWrapper, Arena, ArenaMem, Array,
    BoolVarValue, Boolean, BufUpdateCallbacks, Callback, CallbackReader, CallbackType,
