...
pub use crate::src::nvim::types::{
    ...
    CSType, Callback, CallbackType, Callback_data as C2Rust_Unnamed_4, ChangedtickDictItem,
    CharInfo, CharSize, CharsizeArg, DecorExt, DecorHighlightInline, DecorInline, DecorInlineData,
    DecorPriority, DecorVirtText, DecorVirtText_data as C2Rust_Unnamed_1, ExtmarkUndoObject,
    ...
    MarkTree, MarkTreeIter, MarkTreeIter_s as C2Rust_Unnamed_14, MetaFilter, MetaIndex, OptInt,
    ScopeDictDictItem, ScopeType, ScreenGrid, Set_int64_t, Set_uint32_t, Set_uint64_t,
    SpecialVarValue, StlClickDefinition, StlClickDefinition_type_0 as C2Rust_Unnamed_11,
    StrCharInfo, Terminal, Timestamp, VarLockStatus, VarType, VirtLines, VirtText, VirtTextChunk,
