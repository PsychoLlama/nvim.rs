...
pub use crate::src::nvim::types::{
    ...
    BoolVarValue, Boolean, BufUpdateCallbacks, Callback, CallbackType,
    Callback_data as C2Rust_Unnamed_5, ChangedtickDictItem, DecorExt, DecorHighlightInline,
    DecorInline, DecorInlineData, DecorPriority, DecorPriorityInternal, DecorRange, DecorRangeKind,
    DecorRangeSlot, DecorRange_data as C2Rust_Unnamed_22, DecorRange_data_ui as C2Rust_Unnamed_23,
    DecorSignHighlight, DecorState, DecorState_ranges_i as C2Rust_Unnamed_24,
    DecorState_slots as C2Rust_Unnamed_25, DecorVirtText, DecorVirtText_data as C2Rust_Unnamed_2,
    Dict, Error, ErrorType, ExtmarkMove, ExtmarkSavePos, ExtmarkSplice, ExtmarkUndoObject, FileID,
    Float, FloatAnchor, FloatRelative, GridView, Integer, Intersection, KeyValuePair, LuaRef,
    MTKey, MTNode, MTPair, MTPos, MapHash, Map_int64_t_int64_t, Map_int64_t_ptr_t,
