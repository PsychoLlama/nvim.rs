...
pub struct file_buffer {
    ...
    pub b_wininfo: C2Rust_Unnamed_22,
    ...
    pub b_s: synblock_T,
    pub b_signcols: C2Rust_Unnamed_14,
    ...
    pub update_channels: C2Rust_Unnamed_12,
    pub update_callbacks: C2Rust_Unnamed_11,
...
pub struct syn_state {
    ...
    pub sst_union: C2Rust_Unnamed_15,
...
pub struct funccall_S {
    ...
    pub fc_fixvar: [C2Rust_Unnamed_17; 12],
...
#[repr(C)]
pub struct u_header {
    pub uh_next: C2Rust_Unnamed_21,
    pub uh_prev: C2Rust_Unnamed_20,
    pub uh_alt_next: C2Rust_Unnamed_19,
    pub uh_alt_prev: C2Rust_Unnamed_18,
...
pub struct loop_0 {
    ...
    pub children: C2Rust_Unnamed_24,
...
unsafe extern "C" fn handle_mouse_event(
        ...
        && advance != 0
    {
        if col >= 0 as ::core::ffi::c_int && row >= 0 as ::core::ffi::c_int {
            if col >= Columns {
                col = Columns - 1 as ::core::ffi::c_int;
            }
            if row >= Rows {
