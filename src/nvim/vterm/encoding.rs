...
static mut encoding_usascii: VTermEncoding = VTermEncoding {
    init: None,
    decode: Some(
        decode_usascii
            as unsafe extern "C" fn(
...
static mut encoding_DECdrawing: StaticTableEncoding = StaticTableEncoding {
    enc: VTermEncoding {
        init: None,
        decode: Some(
            decode_table
...
static mut encodings: [C2Rust_Unnamed; 4] = unsafe {
    [
        C2Rust_Unnamed {
            type_0: ENC_UTF8,
            designation: 'u' as ::core::ffi::c_char,
            enc: &raw const encoding_utf8 as *mut VTermEncoding,
        },
        C2Rust_Unnamed {
            type_0: ENC_SINGLE_94,
            designation: '0' as ::core::ffi::c_char,
            enc: &raw const encoding_DECdrawing as *mut VTermEncoding,
        },
        C2Rust_Unnamed {
            type_0: ENC_SINGLE_94,
            designation: 'B' as ::core::ffi::c_char,
            enc: &raw const encoding_usascii as *mut VTermEncoding,
        },
        C2Rust_Unnamed {
            type_0: ENC_UTF8,
            designation: 0,
...
pub unsafe extern "C" fn vterm_lookup_encoding(
    ...
    while encodings[i as usize].designation != 0 {
        ...
        {
            return encodings[i as usize].enc;
        }
        i += 1;
    }
