...
// edit() is implemented in Rust (src/nvim-rs/edit/src/redraw.rs).
// The C nvim_edit_edit_entry has been replaced by the Rust rs_edit function.
...
// nvim_edit_ins_tab_replace_spaces is implemented in Rust (tab.rs).
