...
extern "C" {
    ...
    fn match_compoundrule(slang: *mut slang_T, compflags: *const uint8_t) -> bool;
    fn valid_word_prefix(
        totprefcnt: ::core::ffi::c_int,
        arridx: ::core::ffi::c_int,
    ...
    fn spell_iswordp(p: *const ::core::ffi::c_char, wp: *const win_T) -> bool;
    fn spell_iswordp_nmw(p: *const ::core::ffi::c_char, wp: *mut win_T) -> bool;
    fn spell_casefold(
        wp: *const win_T,
    ...
    fn allcap_copy(word: *const ::core::ffi::c_char, wcopy: *mut ::core::ffi::c_char);
    fn nofold_len(
        fword: *mut ::core::ffi::c_char,
        flen: ::core::ffi::c_int,
        word: *mut ::core::ffi::c_char,
    ) -> ::core::ffi::c_int;
    fn make_case_word(
        fword: *mut ::core::ffi::c_char,
        cword: *mut ::core::ffi::c_char,
        flags: ::core::ffi::c_int,
    );
    fn spell_soundfold(
        slang: *mut slang_T,
...
pub unsafe extern "C" fn spell_suggest(mut count: ::core::ffi::c_int) {
    ...
    let mut prev_cursor: pos_T = (*curwin).w_cursor;
        ...
        if *(*(*curwin).w_s).b_p_spl as ::core::ffi::c_int == NUL {
                ...
                && u_save_cursor() == OK
            {
                ...
                *ptr__0;
                ...
                ml_replace((*curwin).w_cursor.lnum, p_0, false_0 != 0);
                (*curwin).w_cursor.col = c as colnr_T;
                inserted_bytes(
...
unsafe extern "C" fn spell_find_suggest(
    ...
    let mut sps_copy: *mut ::core::ffi::c_char = xstrdup(p_sps);
...
unsafe extern "C" fn spell_suggest_intern(mut su: *mut suginfo_T, mut interactive: bool) {
    ...
    os_breakcheck();
    if interactive as ::core::ffi::c_int != 0 && got_int as ::core::ffi::c_int != 0 {
        vgetc();
        got_int = false_0 != 0;
    }
                            ...
                            match (*sp).ts_state as ::core::ffi::c_uint {
                                ...
                                8 => {
                                    ...
                                    if c == NUL {
                                        (*sp).ts_state = STATE_FINAL;
                                        break 's_2231;
                                    } else if !soundfold && !spell_iswordp(p, curwin) {
                                        ...
                                        if *p.offset(n as isize) as ::core::ffi::c_int == NUL {
                                            ...
                                            && !spell_iswordp(p.offset(n as isize), curwin)
                                        {
                                            c2 = c;
                                        } else {
