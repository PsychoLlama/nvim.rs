...
# The row was first baselined at commit 19ea4122e8 -- B14-2's close, i.e. after the
...
"$HERE/evalsweep.sh" "$NVIM_BIN" "$REPO/runtime" \
...
BASELINE=${EVAL_BASELINE:-$("$HERE/baseline.sh" eval)}
fail=0
