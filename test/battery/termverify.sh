...
#
# The baseline lives next to this script in termbase/ and was
...
# and reviewed:
#
#   termsweep.sh <nvim> <runtime> \
#       test/battery/termbase base
#
...
BASELINE=${TERM_BASELINE:-$HERE/termbase}
...
"$HERE/termsweep.sh" "$REPO/target/debug/nvim" "$REPO/runtime" \
