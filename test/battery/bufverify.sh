...
#
# The baseline lives next to this script in bufbase/ and was
...
# set to carry.  Regenerate it only when a behaviour change is
# *intended* and reviewed:
#
#   bufsweep.sh <nvim> <runtime> \
#       test/battery/bufbase base
#
...
BASELINE=${BUF_BASELINE:-$HERE/bufbase}
...
"$HERE/bufsweep.sh" "$REPO/target/debug/nvim" "$REPO/runtime" \
