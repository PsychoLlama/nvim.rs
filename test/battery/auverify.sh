...
# The row was first baselined at commit 3273bf014a -- B14-4's assertion-demotion commit,
...
"$HERE/ausweep.sh" "$NVIM_BIN" "$REPO/runtime" \
...
BASELINE=${AU_BASELINE:-$("$HERE/baseline.sh" au)}
fail=0
